...
/**
 * Contract for loading a persisted model instance from the Data Services (DS).
 *
...
public interface IModelLoader<T extends Model> {
	 ...
	 * @throws org.springframework.security.access.AccessDeniedException if the current user/principal is not allowed to read the target model.
	 */
