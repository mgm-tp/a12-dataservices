...
public class CustomTypeValidationTest {
	...
	private final TaxIDCustomFieldType type = new TaxIDCustomFieldType();
	private final ICustomFieldTypeValidationParam valParam = mock(ICustomFieldTypeValidationParam.class);

	@Test
	public void testInvalidEntry() {
		Optional<ICustomFieldTypeCheckError> error = type.validate("abcde", valParam, false);
	...
	public void testValidEntry() {
		Optional<ICustomFieldTypeCheckError> error = type.validate("BR12345678", valParam, false);
