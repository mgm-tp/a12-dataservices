...
@SpringBootTest(classes = ExampleSerializationConfiguration.class)
@TestPropertySource(properties = "com.mgmtp.a12.examples.documents.serialization.enabled=true")
public class ExampleSerializationConfigurationIT extends AbstractTestNGSpringContextTests {

	@Autowired
	DocumentSerializationConfig serializationConfig;

	@Autowired
	DocumentDeserializationConfig deserializationConfig;
