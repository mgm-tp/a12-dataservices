...
public class CustomTypeConversionTest {
	...
	public void convertDisplayInvalid() {
		...
		ICustomFieldTypeConversionResult result = type.convertDisplay2Internal("INVALIDDATA");
	...
	public void convertDisplayValid() {
		TaxIDCustomFieldType type = new TaxIDCustomFieldType();
		ICustomFieldTypeConversionResult result = type.convertDisplay2Internal("BR-12345678");
	...
	public void convertInternalInvalid() {
		TaxIDCustomFieldType type = new TaxIDCustomFieldType();
		ICustomFieldTypeConversionResult result = type.convertInternal2Display("INVALIDDATA");
		Assert.assertTrue(result.getErrorMessage().isPresent());
	...
	public void convertInternalValid() {
		TaxIDCustomFieldType type = new TaxIDCustomFieldType();
		ICustomFieldTypeConversionResult result = type.convertInternal2Display("BR12345678");
		Assert.assertFalse(result.getErrorMessage().isPresent());
