...
var Meta_Felder_businesspartnerltd = (function () {
	function Meta_Felder_businesspartnerltd() {
	...
	Meta_Felder_businesspartnerltd.prototype.getFelder = function () {
		return this._felder;
	};

	Meta_Felder_businesspartnerltd.prototype._initFeldtypen = function () {
	...
	this._metaFormate.set(
		6,
		new FormatDefinitionString(
			this._mehrsprachigeFehlertexte.get(6),
			["100%", "90%", "80%", "70%", "60%", "50%", "40%", "30%", "20%", "10%"],
			this._enumerationOberflaechenWerte.get(6),
			this._enumerationCategoryValues.get(6),
			""
		)
	);
	this._metaFormate.set(
	 ...
	 */
	Meta_Felder_businesspartnerltd.prototype._initFelder = function () {
	this._felder.push(
		new Feld_t(
			0,
			"original_filename",
			...
			"businesspartnerltdoriginal_filenameValidate",
			[],
			[],
			new MapBuilder()
	...
	this._felder.push(
		new Feld_t(
			...
			true,
			this._metaFormate.get(0),
			"businesspartnerltdinternal_filenameValidate",
			[],
			[],
			new MapBuilder()
				.put("DruckText", new MapBuilder().build())
	...
	this._felder.push(
		new Feld_t(
			...
			"businesspartnerltdcontentValidate",
			[],
			[],
			new MapBuilder()
				.put("DruckText", new MapBuilder().build())
	...
	this._felder.push(
		new Feld_t(
			...
			false,
			this._metaFormate.get(0),
			"businesspartnerltdattachment_idValidate",
			[],
			[],
			new MapBuilder()
				.put("DruckText", new MapBuilder().build())
	...
	this._felder.push(
		new Feld_t(
			...
			"businesspartnerltdsizeValidate",
			[],
			[],
			new MapBuilder()
				.put("DruckText", new MapBuilder().build())
	...
	this._felder.push(
		new Feld_t(
			...
			true,
			this._metaFormate.get(0),
			"businesspartnerltdmime_typeValidate",
			[],
			[],
			new MapBuilder()
				.put("DruckText", new MapBuilder().build())
	...
	this._felder.push(
		new Feld_t(
			...
			false,
			this._metaFormate.get(0),
			"businesspartnerltdcategoryValidate",
			[],
			[],
			new MapBuilder()
				.put("DruckText", new MapBuilder().build())
	...
	this._felder.push(
		new Feld_t(
			...
			false,
			this._metaFormate.get(0),
			"businesspartnerltddescriptionValidate",
			[],
			[],
			new MapBuilder()
				.put("DruckText", new MapBuilder().build())
	...
	this._felder.push(
		new Feld_t(
			...
			false,
			this._metaFormate.get(0),
			"businesspartnerltdNameValidate",
			[0],
			[0],
			new MapBuilder()
	...
	this._felder.push(
		new Feld_t(
			...
			"businesspartnerltdIndustryValidate",
			[0],
			[0],
			new MapBuilder()
	...
	this._felder.push(
		new Feld_t(
			...
			"businesspartnerltdStartOfRelationshipValidate",
			[],
			[],
			new MapBuilder()
	...
	this._felder.push(
		new Feld_t(
			...
			"businesspartnerltdincomeValidate",
			[],
			[],
			new MapBuilder()
	...
	this._felder.push(
		new Feld_t(
			...
			"businesspartnerltdCustomerDiscountValidate",
			[0],
			[0],
			new MapBuilder()
	...
	this._felder.push(
		new Feld_t(
			...
			false,
			this._metaFormate.get(0),
			"businesspartnerltdPersonOrEntityValidate",
			[],
			[],
			new MapBuilder()
	...
	this._felder.push(
		new Feld_t(
			15,
			"Type",
			"/BusinessPartnerRoot/SubtypeGroup/Type",
			false,
			false,
			this._metaFormate.get(7),
			"businesspartnerltdTypeValidate",
			[],
			[],
			new MapBuilder()
				.put("DruckText", new MapBuilder().put("en", "Type of Legal Entity").build())
				.put("GlobalesFeld", false)
				.put("ExplicitlyMandatory", false)
				.put("TransientField", false)
				.put("IndexField", false).build(),
	...
	this._felder.push(
		new Feld_t(
			...
			false,
			this._metaFormate.get(0),
			"businesspartnerltddocRefValidate",
			[],
			[],
			new MapBuilder()
	...
	this._felder.push(
		new Feld_t(
			...
			false,
			this._metaFormate.get(0),
			"businesspartnerltdmodelReferenceValidate",
			[],
			[],
			new MapBuilder()
	...
	this._felder.push(
		new Feld_t(
			...
			false,
			this._metaFormate.get(0),
			"businesspartnerltdmodelVersionValidate",
			[],
			[],
			new MapBuilder()
	...
	this._felder.push(
		new Feld_t(
			...
			false,
			this._metaFormate.get(0),
			"businesspartnerltdcreatorValidate",
			[],
			[],
			new MapBuilder()
	...
	this._felder.push(
		new Feld_t(
			...
			"businesspartnerltdcreatedAtValidate",
			[],
			[],
			new MapBuilder()
	...
	this._felder.push(
		new Feld_t(
			...
			false,
			this._metaFormate.get(0),
			"businesspartnerltdmodifierValidate",
			[],
			[],
			new MapBuilder()
	...
	this._felder.push(
		new Feld_t(
			...
			false,
			this._metaFormate.get(8),
			"businesspartnerltdmodifiedAtValidate",
			[],
			[],
			new MapBuilder()
	...
	Meta_Felder_businesspartnerltd.prototype._initFeldFehlertexte = function () {
	this._mehrsprachigeFehlertexte.set(3, new Map());

	this._mehrsprachigeFehlertexte.set(6, new Map());

	this._mehrsprachigeFehlertexte.set(7, new Map());

	};
	Meta_Felder_businesspartnerltd.prototype._initEnumerationOberflaechenWerte = function () {
	...
	this._enumerationOberflaechenWerte.set(6, new Map());
	this._enumerationOberflaechenWerte.get(6).set("de", MetaFeldUtil.createPairList(["0%_Rabbat", "10%_Rabbat", "20%_Rabbat", "30%_Rabbat", "40%_Rabbat", "50%_Rabbat", "60%_Rabbat", "70%_Rabbat", "80%_Rabbat", "90%_Rabbat"], ["100%", "90%", "80%", "70%", "60%", "50%", "40%", "30%", "20%", "10%"]));
	this._enumerationOberflaechenWerte.get(6).set("en", MetaFeldUtil.createPairList(["0%_Discount", "10%_Discount", "20%_Discount", "30%_Discount", "40%_Discount", "50%_Discount", "60%_Discount", "70%_Discount", "80%_Discount", "90%_Discount"], ["100%", "90%", "80%", "70%", "60%", "50%", "40%", "30%", "20%", "10%"]));
	this._enumerationOberflaechenWerte.get(6).set("en_US", MetaFeldUtil.createPairList(["100%", "90%", "80%", "70%", "60%", "50%", "40%", "30%", "20%", "10%"], ["100%", "90%", "80%", "70%", "60%", "50%", "40%", "30%", "20%", "10%"]));

	this._enumerationOberflaechenWerte.set(7, new Map());
	this._enumerationOberflaechenWerte.get(7).set("de", MetaFeldUtil.createPairList(["GmbH", "AG", "KG", "PLC", "LLC"], ["GmbH", "AG", "KG", "PLC", "LLC"]));
	this._enumerationOberflaechenWerte.get(7).set("en", MetaFeldUtil.createPairList(["GmbH", "AG", "KG", "PLC", "LLC"], ["GmbH", "AG", "KG", "PLC", "LLC"]));
	this._enumerationOberflaechenWerte.get(7).set("en_US", MetaFeldUtil.createPairList(["GmbH", "AG", "KG", "PLC", "LLC"], ["GmbH", "AG", "KG", "PLC", "LLC"]));

	};


	return Meta_Felder_businesspartnerltd;
}());
var Meta_Regel_businesspartnerltd = (function () {
	function Meta_Regel_businesspartnerltd() {
		var _this = this;
		this._regeln = new Array();
		// speichert pro Regel die referenzierten Identifier
		this._refIdentifier = new Array(Meta_Regel_businesspartnerltd.ANZAHL_REGELN);
		// speichert pro Regel die referenzierten Identifier, die Auslassungsfehler erzeugen können
		this._refAuslassungsIdentifier = new Array(Meta_Regel_businesspartnerltd.ANZAHL_REGELN);
		// speichert pro Regel die Vordrucke, die einen Auslassungsfehler erzeugen können
		this._refAuslassungsVordrucke = new Array(Meta_Regel_businesspartnerltd.ANZAHL_REGELN);
		this._mehrsprachigeFehlertexte = new Map();
		this._fehlertexteParameterMapping = new Map();
		this._constructor = (function () {
			for (var i = 0; i < Meta_Regel_businesspartnerltd.ANZAHL_REGELN; i++) {
	...
	Meta_Regel_businesspartnerltd.prototype.getRegeln = function () {
		return this._regeln;
	};
	Meta_Regel_businesspartnerltd.ANZAHL_REGELN = 9;

	Meta_Regel_businesspartnerltd.prototype._initRegelRefs = function () {
	...
	this._refIdentifier[4] = [
			new Identifier_t(8, [1, 1], ReferenzTyp.KEINE_BERECHNUNG, null, null)];
	...
	this._refIdentifier[5] = [
			new Identifier_t(9, [1, 1], ReferenzTyp.KEINE_BERECHNUNG, null, null)];
	...
	this._refIdentifier[7] = [
			new Identifier_t(13, [1, 1], ReferenzTyp.KEINE_BERECHNUNG, null, null)];
	...
	this._refIdentifier[8] = [
			new Identifier_t(10, [1, 1], ReferenzTyp.KEINE_BERECHNUNG, null, null),

			new Identifier_t(13, [1, 1], ReferenzTyp.KEINE_BERECHNUNG, null, null),

			new Identifier_t(14, [1, 1], ReferenzTyp.KEINE_BERECHNUNG, null, null),
	...
	Meta_Regel_businesspartnerltd.prototype._initRegelFehlertexte = function () {
	// Init Daten zur Regel '/BusinessPartnerRoot/Attachment/AttachmentInternalFilenameRequired'
	...
	// Init Daten zur Regel '/BusinessPartnerRoot/NameFilled'
	this._mehrsprachigeFehlertexte.get(4).set("de", "Interner Fehler: Name muss ausgefüllt sein.");this._mehrsprachigeFehlertexte.get(4).set("en", "Internal Error: Name must be filled.");
	this._fehlertexteParameterMapping.set(4, new MapBuilder().build());
	// Init Daten zur Regel '/BusinessPartnerRoot/IndustryFilled'
	this._mehrsprachigeFehlertexte.get(5).set("de", "Interner Fehler: Industry muss ausgefüllt sein.");this._mehrsprachigeFehlertexte.get(5).set("en", "Internal Error: Industry must be filled.");
	this._fehlertexteParameterMapping.set(5, new MapBuilder().build());
	// Init Daten zur Regel '/BusinessPartnerRoot/Employment/TaxComputation'
	this._mehrsprachigeFehlertexte.get(6).set("de", "Berechnungsfehler für TaxComputation");this._mehrsprachigeFehlertexte.get(6).set("en", "Computation error for TaxComputation");
	...
	// Init Daten zur Regel '/BusinessPartnerRoot/SubtypeGroup/EntityComp'
	this._mehrsprachigeFehlertexte.get(8).set("de", "fehlertext zur Berechnung von PersonComp");this._mehrsprachigeFehlertexte.get(8).set("en", "error text for computation of EntityComp");
	 ...
	 */
	Meta_Regel_businesspartnerltd.prototype._initRegeln = function () {
	...
	this._regeln.push(new Regel_t("NameFilled", "/BusinessPartnerRoot/NameFilled", "ErrorR33", this._mehrsprachigeFehlertexte.get(4), this._fehlertexteParameterMapping.get(4), "Fehler", this._refIdentifier[4], this._refAuslassungsIdentifier[4], null, "/BusinessPartnerRoot/Name", false, false, new MapBuilder().build(), new Set()));

	this._regeln.push(new Regel_t("IndustryFilled", "/BusinessPartnerRoot/IndustryFilled", "ErrorR34", this._mehrsprachigeFehlertexte.get(5), this._fehlertexteParameterMapping.get(5), "Fehler", this._refIdentifier[5], this._refAuslassungsIdentifier[5], null, "/BusinessPartnerRoot/Industry", false, false, new MapBuilder().build(), new Set()));

	this._regeln.push(new Regel_t("TaxComputation", "/BusinessPartnerRoot/Employment/TaxComputation", "TaxComputation", this._mehrsprachigeFehlertexte.get(6), this._fehlertexteParameterMapping.get(6), "Fehler", this._refIdentifier[6], this._refAuslassungsIdentifier[6], null, "/BusinessPartnerRoot/Employment/tax", true, false, new MapBuilder().build(), new Set()));
	...
	this._regeln.push(new Regel_t("EntityComp", "/BusinessPartnerRoot/SubtypeGroup/EntityComp", "EntityComp", this._mehrsprachigeFehlertexte.get(8), this._fehlertexteParameterMapping.get(8), "Fehler", this._refIdentifier[8], this._refAuslassungsIdentifier[8], null, "/BusinessPartnerRoot/PersonOrEntity", true, false, new MapBuilder().build(), new Set()));

	};

	return Meta_Regel_businesspartnerltd;
}());
var Meta_PfFeld_businesspartnerltd = (function () {
	function Meta_PfFeld_businesspartnerltd(metaDataValidierung) {
		this._metaDataValidierung = metaDataValidierung;
	}
	Meta_PfFeld_businesspartnerltd.prototype.addLokalePflichtFeldInfos = function (additivUndPflichtfelder) {
		var _this = this;
		var infos = [];
	...
	Meta_PfFeld_businesspartnerltd.prototype._addLokalePflichtFeldInfos_0 = function (infos) {
	...
	Meta_PfFeld_businesspartnerltd.prototype._addLokalePflichtFeldInfo = function (additivUndPflichtfelder, additiv, pflichtfelder) {
	...
	return Meta_PfFeld_businesspartnerltd;
}());
...
var Meta_businesspartnerltd = (function () {
	function Meta_businesspartnerltd() {
		this._metaFelder = new Meta_Felder_businesspartnerltd();
		this._metaRegeln = new Meta_Regel_businesspartnerltd();
		...
		this._da = new Model_t(
				...
				new MapBuilder()
					.put("BaseYear", null)
					.put("TimeZone", "UTC")
					.put("ModelId", "BusinessPartnerLTD")
					.put("Annotation", new MapBuilder()
					.put("roles", "admin").build()).build(),
				new Set(["TimeZone", "BaseYear", "ModelId"])
			);
		if (Meta_businesspartnerltd._instance) {
			throw new Error("Error: Instantiation failed: Use Meta_businesspartnerltd.getInstance() instead of new.");
		}
		Meta_businesspartnerltd._instance = this;
		var container = Meta_businesspartnerltd._initContainer();
		this._meta = new MetaModelImpl(
			this._da,
			this._metaFelder.getFelder(),
			this._metaRegeln.getRegeln(),
			container,
			Meta_businesspartnerltd.LEGAL_CHARACTERS,
			Meta_businesspartnerltd.LEGAL_GRAPHEME_TRIE,
			() => E_businesspartnerltd.getInstance()
        );
		var metaPlfFeldInfo = new Meta_PfFeld_businesspartnerltd(this._meta.getMetaDataValidierung());
		metaPlfFeldInfo
			.addLokalePflichtFeldInfos(this._meta.getValue(IMetaKeysInternal.MODEL_ADDITIV_PFLICHTFELD));
	}
	Object.defineProperty(Meta_businesspartnerltd, "RUNTIME_VERSION", { get: function () { return "31.1"; },
		enumerable: true,
		configurable: true
	});
	Object.defineProperty(Meta_businesspartnerltd, "LEGAL_CHARACTERS_START", {
		get: function () {
			return undefined;
		},
		enumerable: true,
	...
	Object.defineProperty(Meta_businesspartnerltd, "LEGAL_CHARACTERS_END", {
		get: function () {
			return undefined;
		},
		enumerable: true,
	...
	Object.defineProperty(Meta_businesspartnerltd, "LEGAL_CHARACTERS", {
		get: function () {
			return undefined;
		},
		enumerable: true,
	...
	Object.defineProperty(Meta_businesspartnerltd, "LEGAL_GRAPHEME_TRIE", {
    		get: function () {
	...
	Meta_businesspartnerltd.getInstance = function () {
		return Meta_businesspartnerltd._instance;
	};
	Meta_businesspartnerltd.prototype.getValue = function (key) {
		var params = [];
	...
	Meta_businesspartnerltd.prototype.getValidKeys = function () {
		return this._meta.getValidKeys();
	};
	Meta_businesspartnerltd._initContainer = function () {
	...
	Meta_businesspartnerltd.prototype.getMetaDataValidierung = function () {
		return this._meta.getMetaDataValidierung();
	};

	Meta_businesspartnerltd.prototype.isSpracheUnterstuetzt = function (sprache) {
		return this._unterstuetzteSprachen.indexOf(sprache) !== -1;
	};

	Meta_businesspartnerltd._constructor = (function () {
		if (Meta_businesspartnerltd.RUNTIME_VERSION !== Constants.RUNTIME_VERSION) {
			throw new Error("The version of the generated code [" + Meta_businesspartnerltd.RUNTIME_VERSION + "] does not match the version of the used runtime [" + Constants.RUNTIME_VERSION + "]!");
		}
		Meta_businesspartnerltd._instance = new Meta_businesspartnerltd();
	})();
	return Meta_businesspartnerltd;
}());var E_businesspartnerltd = (function () {
	function E_businesspartnerltd() {
		if (E_businesspartnerltd._valueCalcObject) {
			throw new Error("Instantiation failed: Use E_businesspartnerltd.getInstance() instead of new.");
		}
		E_businesspartnerltd._valueCalcObject = this;
		this._feldData = Meta_businesspartnerltd.getInstance();
		this._metaDataValidierung = this._feldData.getMetaDataValidierung();
	}	
	E_businesspartnerltd.getInstance = function () {
		return this._valueCalcObject;
	};


	E_businesspartnerltd.prototype.calcEnumerationValues = function (field, controller) {
	...
	E_businesspartnerltd._valueCalcObject = new E_businesspartnerltd();
	return E_businesspartnerltd;
}());
var C_businesspartnerltd = (function () {
	function C_businesspartnerltd() {
		if (C_businesspartnerltd._checkObject) {
			throw new Error("Instantiation failed: Use C_businesspartnerltd.getInstance() instead of new.");
		}
		C_businesspartnerltd._checkObject = this;
		this._feldData = Meta_businesspartnerltd.getInstance();
		this._metaDataValidierung = this._feldData.getMetaDataValidierung();
	}
	C_businesspartnerltd.getInstance = function () {
		return this._checkObject;
	};

	C_businesspartnerltd.prototype.calc_tax = function (controller) {
	...
	C_businesspartnerltd.prototype.calc_PersonOrEntity = function (controller) {
		...
		try {
			...
			while (innerIterator.hasNext()) {
				var idx = innerIterator.next();
				try {// Berechnungsalternative aus Regel '/BusinessPartnerRoot/SubtypeGroup/EntityComp'
					if (controller.mindestensEinFeldAngegeben(idx, allRtIdCon1).isKnownAndTrue()) {
						var id = RuntimeController.makeIdentifier(idx, rtIdCon1);
						controller.handleBerechnetenWert("Legal Entity", id);
						continue;
					}
				} catch (e) {
					var id = RuntimeController.makeIdentifier(idx, rtIdCon1);
	...
	C_businesspartnerltd.CALCULATED_FIELD_DEPENDENCIES = new Map([
	...
	C_businesspartnerltd.EXPANDED_OPERAND_FIELDS_OF_CALCULATIONS = new Set([
		"/BusinessPartnerRoot/CustomerDiscount",
		"/BusinessPartnerRoot/Employment/income",
		"/BusinessPartnerRoot/Industry",
		"/BusinessPartnerRoot/Name",
	...
	C_businesspartnerltd.CALC_FUNC_NAME_MAP = new Map([
		["/BusinessPartnerRoot/Employment/tax", "calc_tax"],
		["/BusinessPartnerRoot/PersonOrEntity", "calc_PersonOrEntity"]
	]);

	C_businesspartnerltd.CALCULATED_FIELD_FULL_NAMES_IN_ORDER = [
		"/BusinessPartnerRoot/Employment/tax",
		"/BusinessPartnerRoot/PersonOrEntity"
	];

	C_businesspartnerltd.prototype.executeCalculation = function(fullFieldName, controller) {
	    const startMesspunkt = controller.startMesspunkt();
	    const calcFuncName = C_businesspartnerltd.CALC_FUNC_NAME_MAP.get(fullFieldName);
	    this[calcFuncName](controller);
	    controller.logMessung(calcFuncName, startMesspunkt);
    };

    C_businesspartnerltd.prototype.hasCalculation = function(fullFieldName) {
        return C_businesspartnerltd.CALC_FUNC_NAME_MAP.has(fullFieldName);
    };

    C_businesspartnerltd.prototype.getDependencyGraph = function() {
        return C_businesspartnerltd.CALCULATED_FIELD_DEPENDENCIES;
    };

	C_businesspartnerltd.prototype.getExpandedOperandFieldsOfCalculations = function() {
        return C_businesspartnerltd.EXPANDED_OPERAND_FIELDS_OF_CALCULATIONS;
    }

    C_businesspartnerltd.prototype.getCalculatedFieldFullNamesInOrder = function() {
        return C_businesspartnerltd.CALCULATED_FIELD_FULL_NAMES_IN_ORDER;
    }

	C_businesspartnerltd._checkObject = new C_businesspartnerltd();
	return C_businesspartnerltd;
}());
var R_businesspartnerltd = (function () {
	function R_businesspartnerltd() {
		this._feldData = Meta_businesspartnerltd.getInstance();
		this._metaDataValidierung = this._feldData.getMetaDataValidierung();
	}
	R_businesspartnerltd.getInstance = function () {
		return R_businesspartnerltd._checkObject;
	};
	R_businesspartnerltd.prototype.mvk_AttachmentInternalFilenameRequired = function (controller, indices) {
	...
	R_businesspartnerltd.prototype.mvk_AttachmentMimeTypeRequired = function (controller, indices) {
	...
	R_businesspartnerltd.prototype.mvk_AttachmentIdOrContentFilled = function (controller, indices) {
	...
	R_businesspartnerltd.prototype.mvk_SizeOfContentFilled = function (controller, indices) {
	...
	R_businesspartnerltd.prototype.mvk_NameFilled = function (controller, indices) {
	...
	R_businesspartnerltd.prototype.mvk_IndustryFilled = function (controller, indices) {
	...
	R_businesspartnerltd.prototype.mvk_TaxComputation = function (controller, indices) {
	...
	R_businesspartnerltd.prototype.mvk_CustomerDiscountFilled = function (controller, indices) {
	...
	R_businesspartnerltd.prototype.mvk_EntityComp = function (controller, indices) {
		controller.initFuerRegelpruefung("/BusinessPartnerRoot/SubtypeGroup/EntityComp", PruefErgebnisTyp.Fehler);
		var start = [1, 1];
		var ende = [1, 1];
		...
		try {
			...
			while (innerIter.hasNext()) {
				var idx = innerIter.next();
				if (controller.alleFelderAngegeben(idx, allRtIdCon1).isKnownAndTrue()&&controller.mindestensEinFeldAngegeben(idx, allRtIdCon2).isKnownAndTrue()&&controller.vergleicheSTRING(VglOp.NE, controller.feldWert(idx, rtIdCon1), "Legal Entity").isKnownAndTrue()) {
						var tb0 = controller.alleFelderAngegeben(idx, allRtIdCon1);
						var tb1 = controller.mindestensEinFeldAngegeben(idx, allRtIdCon2);
						var tb2 = controller.vergleicheSTRING(VglOp.NE, controller.feldWert(idx, rtIdCon1), "Legal Entity");
						var valErg = tb0.combineUND(tb1).combineUND(tb2);
						controller.addValidatorMessage("PersonOrEntity", idx, "EntityComp", valErg.fehlerTyp);
	...
	R_businesspartnerltd.vordruckF__global = function (controller) {
	...
	R_businesspartnerltd.vordruckF__BusinessPartnerRoot = function (controller) {
	...
	R_businesspartnerltd.vordruckF__BusinessPartnerRoot_lfdNr = function (controller, indices) {
	/* Aufruf der Regeln fuer Vordruck BusinessPartnerRoot für eine spezifische lfdNr. */
		...
		startMesspunkt = controller.startMesspunkt();
		this._checkObject.mvk_EntityComp(controller, indices);
		controller.logMessung("mvk_EntityComp", indices[0], startMesspunkt);
	};
	R_businesspartnerltd.vordruck__global = function (controller) {
	/* Aufruf der Regeln fuer Vordruck global für eine spezifische lfdNr. */
		var indices = [0];
		var startMesspunkt = -1;
		startMesspunkt = controller.startMesspunkt();
	...
	R_businesspartnerltd.vordruck__BusinessPartnerRoot = function (controller) {
		/* Aufruf der Regeln fuer Vordruck BusinessPartnerRoot
		H: nur Hinweise
		F: nur Fehler
		kein Zusatz: fuer alle
	...
	R_businesspartnerltd.vordruck__BusinessPartnerRoot_lfdNr = function (controller, indices) {
	/* Aufruf der Regeln fuer Vordruck BusinessPartnerRoot für eine spezifische lfdNr. */
		var startMesspunkt = -1;
		startMesspunkt = controller.startMesspunkt();
		this._checkObject.mvk_AttachmentInternalFilenameRequired(controller, indices);
	...
	R_businesspartnerltd.prototype.validatePreliminaryRulesForField = function(controller, uniqueFieldName) {
		const validationFunc = R_businesspartnerltd["validatePreliminaryRulesForField__" + uniqueFieldName];
		if (validationFunc != undefined) {
			validationFunc.call(R_businesspartnerltd, controller);
		}
	};

	R_businesspartnerltd.prototype.validatePreliminaryRules = function(controller) {
};

	R_businesspartnerltd.prototype.validiereVoll = function (controller, modus) {
	...
	R_businesspartnerltd.prototype.validiereTeil = function (controller, modus, pruefungsFelderMap) {
		var _this = this;
		var checker;
		switch (modus.getRuleType()) {
			case RuleType.ALL:
		...
		if (controller.getValidationCache().isValidationPartWith3ValueLogic()) {
			var preChecker = new TVCheckPreliminary_businesspartnerltd();
	...
	R_businesspartnerltd.prototype.alleRegeln = function (controller) {
		// Aufruf aller Regeln
		R_businesspartnerltd.vordruck__global(controller);
		R_businesspartnerltd.vordruck__BusinessPartnerRoot(controller);
};
	R_businesspartnerltd.prototype.alleFehlerRegeln = function (controller) {
		// Aufruf aller Fehler-Regeln
		R_businesspartnerltd.vordruckF__global(controller);
		R_businesspartnerltd.vordruckF__BusinessPartnerRoot(controller);
};
	R_businesspartnerltd.prototype.alleHinweisRegeln = function (controller) {
		// Aufruf aller Hinweis-Regeln
};
	R_businesspartnerltd.prototype.alleInfoRegeln = function (controller) {
        // Aufruf aller Info-Regeln
};
	R_businesspartnerltd._checkObject = new R_businesspartnerltd();
	return R_businesspartnerltd;
}());
/**
 * Diese Klasse dient der Ausführung von Teilvalidierungen von Fehlern.
 *
 */
var TVCheckFehler_businesspartnerltd = (function () {
	function TVCheckFehler_businesspartnerltd() {
		this._checkObject = R_businesspartnerltd.getInstance();
	}
	TVCheckFehler_businesspartnerltd.prototype.fuehreAus = function (controller, interneFeldNr, indices) {
		if (interneFeldNr <= 14) {
	...
	*/
	...
	TVCheckFehler_businesspartnerltd.prototype._fuehreAus_0 = function(controller, interneFeldNr, indices) {
		var startMesspunkt = -1;
		switch (interneFeldNr) {
			...
			if (interneFeldNr <= 14) {
				...
				throw new Error("Die interne Feldnummer " + interneFeldNr + " liegt nicht im Interval [1,14].");
			}
			break;
		}
	};

	return TVCheckFehler_businesspartnerltd;
}());
var TVCheckHinweis_businesspartnerltd = (function () {
	function TVCheckHinweis_businesspartnerltd() {
		this._checkObject = R_businesspartnerltd.getInstance();
	}
	TVCheckHinweis_businesspartnerltd.prototype.fuehreAus = function (controller, interneFeldNr, indices) {
			// The model does not contain any rules of severity 'WARNING'.
	};
	return TVCheckHinweis_businesspartnerltd;
}());
var TVCheckInfo_businesspartnerltd = (function () {
	function TVCheckInfo_businesspartnerltd() {
		this._checkObject = R_businesspartnerltd.getInstance();
	}
	TVCheckInfo_businesspartnerltd.prototype.fuehreAus = function (controller, interneFeldNr, indices) {
			// The model does not contain any rules of severity 'INFO'.
	};
	return TVCheckInfo_businesspartnerltd;
}());
/**
 * Diese Klasse dient der Ausführung von Teilvalidierungen von Infos, Hinweisen und Fehlern.
 *
 */
var TVCheckAlle_businesspartnerltd = (function () {
	function TVCheckAlle_businesspartnerltd() {
		this._tvFehlerChecker = new TVCheckFehler_businesspartnerltd();
		this._tvHinweisChecker = new TVCheckHinweis_businesspartnerltd();
		this._tvInfoChecker = new TVCheckInfo_businesspartnerltd();
	}
	TVCheckAlle_businesspartnerltd.prototype.fuehreAus = function (controller, interneFeldNr, indices) {
	...
	return TVCheckAlle_businesspartnerltd;
}());
var TVCheckPreliminary_businesspartnerltd = (function () {
	function TVCheckPreliminary_businesspartnerltd() {
		this._checkObject = R_businesspartnerltd.getInstance();
	}
	TVCheckPreliminary_businesspartnerltd.prototype.fuehreAus = function (controller, interneFeldNr, indices) {
			// The model does not contain any preliminary rules.
	};
	return TVCheckPreliminary_businesspartnerltd;
}());
var ERValidator_businesspartnerltd = (function () {
	function ERValidator_businesspartnerltd() {
		if (ERValidator_businesspartnerltd._instance) {
			throw new Error("Error: Instantiation failed: Use ERValidator_businesspartnerltd.getInstance() instead of new.");
		}
		ERValidator_businesspartnerltd._instance = this;
	}
	ERValidator_businesspartnerltd.getInstance = function () {
		return ERValidator_businesspartnerltd._instance;
	};
	ERValidator_businesspartnerltd.prototype.pruefeParams = function (daten, ergebnis, logger, modus) {
		if (!daten) {
	...
	ERValidator_businesspartnerltd.prototype.validatePartlyWith3ValueLogic = function (daten, relevantEntities, ergebnis, modus, logger) {
        this.pruefeParams(daten, ergebnis, logger, modus);
        var c = new ValidationCommand(R_businesspartnerltd.getInstance(), modus, ERValidator_businesspartnerltd._metaData, logger);
        c.processPartlyValidation(daten, relevantEntities, ergebnis);
	}
	ERValidator_businesspartnerltd.prototype.validateAll = function (daten, ergebnis, modus, logger) {
        this.pruefeParams(daten, ergebnis, logger, modus);
        var c = new ValidationCommand(R_businesspartnerltd.getInstance(), modus, ERValidator_businesspartnerltd._metaData, logger);
        c.processFullValidation(daten, ergebnis);
	};
	ERValidator_businesspartnerltd.prototype.calculateAll = function (daten, modus, ergebnis, logger, externalCalculations, changedFieldInstances, forceCalculationSorting) {
        this.pruefeParams(daten, ergebnis, logger, modus);
        var c = new CalculationCommand(R_businesspartnerltd.getInstance(), modus, ERValidator_businesspartnerltd._metaData, logger, C_businesspartnerltd.getInstance(), externalCalculations, changedFieldInstances, forceCalculationSorting);
        var result = c.processCalc(daten, ergebnis);
        return result;
	};
	ERValidator_businesspartnerltd._instance = new ERValidator_businesspartnerltd();
	ERValidator_businesspartnerltd._metaData = Meta_businesspartnerltd.getInstance().getMetaDataValidierung();
	// typescript has no static initializer, so this is used
	ERValidator_businesspartnerltd._constructor = (function () {
	})();
	return ERValidator_businesspartnerltd;
}());

return {
	validator: ERValidator_businesspartnerltd,
	meta: Meta_businesspartnerltd
};
