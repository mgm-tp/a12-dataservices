 ...
 *
 */
public class  Meta_PfFeld_businesspartnersuper {

    private final IMetaDataValidierung metaDataValidierung;

    Meta_PfFeld_businesspartnersuper(IMetaDataValidierung metaDataValidierung) {
    ...
    void addLokalePflichtFeldInfos(Set<MetaLokalePflichtInfo> additivUndPflichtfelder) {
        ...
        for (String [] info : infos) {
            addLokalePflichtFeldInfo(
                    ...
                    info[0],
                    info[1],
                    Meta_businesspartnersuper.getMetaFSMenge(info[2]),
                    Meta_businesspartnersuper.getMetaFSMenge(info[3]));
        }
