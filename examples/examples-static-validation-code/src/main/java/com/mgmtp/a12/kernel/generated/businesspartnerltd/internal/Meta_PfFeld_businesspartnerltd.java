 ...
 *
 */
public class  Meta_PfFeld_businesspartnerltd {

    private final IMetaDataValidierung metaDataValidierung;

    Meta_PfFeld_businesspartnerltd(IMetaDataValidierung metaDataValidierung) {
    ...
    void addLokalePflichtFeldInfos(Set<MetaLokalePflichtInfo> additivUndPflichtfelder) {
        ...
        for (String [] info : infos) {
            addLokalePflichtFeldInfo(
                    ...
                    info[0],
                    info[1],
                    Meta_businesspartnerltd.getMetaFSMenge(info[2]),
                    Meta_businesspartnerltd.getMetaFSMenge(info[3]));
        }
