...
public class  E_contractcdm implements IDynEnumsIntern {
	private static final E_contractcdm valueCalcObject = new E_contractcdm();
	...
	public static E_contractcdm getInstance() {
