...
public class C_businesspartnersuper implements ICalculatorIntern {
	private static final C_businesspartnersuper checkObject = new C_businesspartnersuper();
	...
	public static C_businesspartnersuper getInstance() {
		return checkObject;
	}
