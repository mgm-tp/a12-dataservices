...
public class C_businesspartnerltd implements ICalculatorIntern {
	private static final C_businesspartnerltd checkObject = new C_businesspartnerltd();
	...
	public static C_businesspartnerltd getInstance() {
		return checkObject;
	}
