...
public class Meta_anonymizedbusinesspartnercdm implements IMetaModel, IMetaEntityInternal {
    ...
    private final List<Locale> unterstuetzteSprachen = Arrays.asList( Locale.of("en"), Locale.US );

    private static final Map<Locale, PresentationInformationValues> DEFAULT_PRESENTATION_INFO = new MapBuilder<Locale, PresentationInformationValues>().put(Locale.of("en"), new PresentationInformationValues(".", ",", "-", "JMT", PresentationInformation.FALSE, "~", "MM/dd/yyyy HH:mm", "HH:mm")).put(Locale.US, new PresentationInformationValues(".", ",", "-", "JMT", PresentationInformation.FALSE, "~", "yyyy-MM-dd HH:mm", "HH:mm")).build();
	...
	private Model_t da = new Model_t (
	    ...
	    '.', //dezimaltrenner
		Arrays.asList( Locale.of("en"), Locale.US ), // unterstuetzte Sprachen
