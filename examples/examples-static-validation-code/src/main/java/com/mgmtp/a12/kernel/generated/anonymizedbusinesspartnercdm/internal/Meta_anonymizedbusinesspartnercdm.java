...
public class Meta_anonymizedbusinesspartnercdm implements IMetaModel, IMetaEntityInternal {
    ...
    private Meta_Felder_anonymizedbusinesspartnercdm metaFelder = new Meta_Felder_anonymizedbusinesspartnercdm();
    private Meta_Regel_anonymizedbusinesspartnercdm metaRegeln = new Meta_Regel_anonymizedbusinesspartnercdm();
    private final List<Locale> unterstuetzteSprachen = Arrays.asList( new Locale("en"), Locale.US );

    private static final Map<Locale, PresentationInformationValues> DEFAULT_PRESENTATION_INFO = new MapBuilder<Locale, PresentationInformationValues>().put(new Locale("en"), new PresentationInformationValues(".", ",", "-", "JMT", PresentationInformation.FALSE, "~", "MM/dd/yyyy HH:mm", "HH:mm")).put(Locale.US, new PresentationInformationValues(".", ",", "-", "JMT", PresentationInformation.FALSE, "~", "yyyy-MM-dd HH:mm", "HH:mm")).build();
    ...
    private static final Meta_anonymizedbusinesspartnercdm instance = new Meta_anonymizedbusinesspartnercdm();

	static {
	}

    public static Meta_anonymizedbusinesspartnercdm getInstance() {
        return instance;
    }
	...
	private static void initContainer_0(Container_t[] result){
	     ...
	     result[1] = new Container_t("/__meta", Long.valueOf(1), new String[] {}, new MapBuilder<String, Object>().build(), Set.of());
	     result[2] = new Container_t("/__meta/extensions", Long.valueOf(1), new String[] {}, new MapBuilder<String, Object>().build(), Set.of());
	}


	static Container_t[] initContainer() {
		Container_t[] result = new Container_t[3];
	...
	private Model_t da = new Model_t (
	    ...
	    '.', //dezimaltrenner
		Arrays.asList( new Locale("en"), Locale.US ), // unterstuetzte Sprachen
		...
		null,
	    // additional Values:
	    new MapBuilder<String, Object>().put("BaseYear", null).put("TimeZone", "UTC").put("ModelId", "AnonymizedBusinessPartnerCDM").put("Annotation", new MapBuilder<String, Object>().put("roles", "admin,guest").put("cdm.queryRoot", "BusinessPartner").build()).build(),
	...
	private Meta_anonymizedbusinesspartnercdm() {
	    ...
	    meta = new MetaModelImpl(
					...
					ERValidator_anonymizedbusinesspartnercdm::getInstance);
		...
		Meta_PfFeld_anonymizedbusinesspartnercdm metaPlfFeldInfo = new Meta_PfFeld_anonymizedbusinesspartnercdm (getMetaDataValidierung());
