...
public class Meta_businesspartnerltd implements IMetaModel, IMetaEntityInternal {
    ...
    private Meta_Felder_businesspartnerltd metaFelder = new Meta_Felder_businesspartnerltd();
    private Meta_Regel_businesspartnerltd metaRegeln = new Meta_Regel_businesspartnerltd();
    ...
    private static final Meta_businesspartnerltd instance = new Meta_businesspartnerltd();

	static {
	}

    public static Meta_businesspartnerltd getInstance() {
        return instance;
    }
	...
	private static void initContainer_0(Container_t[] result){
	     ...
	     result[3] = new Container_t("/BusinessPartnerRoot/SubtypeGroup", Long.valueOf(1), new String[] {}, new MapBuilder<String, Object>().build(), Set.of());
	     result[4] = new Container_t("/__meta", Long.valueOf(1), new String[] {}, new MapBuilder<String, Object>().build(), Set.of());
	     result[5] = new Container_t("/__meta/extensions", Long.valueOf(1), new String[] {}, new MapBuilder<String, Object>().build(), Set.of());
	}


	static Container_t[] initContainer() {
		Container_t[] result = new Container_t[6];
	...
	private Model_t da = new Model_t (
		...
		null,
	    // additional Values:
	    new MapBuilder<String, Object>().put("BaseYear", null).put("TimeZone", "UTC").put("ModelId", "BusinessPartnerLTD").put("Annotation", new MapBuilder<String, Object>().put("roles", "admin").build()).build(),
	...
	private Meta_businesspartnerltd() {
	    ...
	    meta = new MetaModelImpl(
					...
					ERValidator_businesspartnerltd::getInstance);
		...
		Meta_PfFeld_businesspartnerltd metaPlfFeldInfo = new Meta_PfFeld_businesspartnerltd (getMetaDataValidierung());
