 ...
 *
 */
public class  Meta_PfFeld_coinsuredadditionalfields {

    private final IMetaDataValidierung metaDataValidierung;

    Meta_PfFeld_coinsuredadditionalfields(IMetaDataValidierung metaDataValidierung) {
    ...
    void addLokalePflichtFeldInfos(Set<MetaLokalePflichtInfo> additivUndPflichtfelder) {
        ...
        for (String [] info : infos) {
            addLokalePflichtFeldInfo(
                    ...
                    info[0],
                    info[1],
                    Meta_coinsuredadditionalfields.getMetaFSMenge(info[2]),
                    Meta_coinsuredadditionalfields.getMetaFSMenge(info[3]));
        }
