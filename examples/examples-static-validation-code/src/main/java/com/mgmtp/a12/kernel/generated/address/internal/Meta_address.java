...
public class Meta_address implements IMetaModel, IMetaEntityInternal {
    ...
    private Meta_Felder_address metaFelder = new Meta_Felder_address();
    private Meta_Regel_address metaRegeln = new Meta_Regel_address();
    ...
    private static final Meta_address instance = new Meta_address();

	static {
	}

    public static Meta_address getInstance() {
        return instance;
    }
	...
	private static void initContainer_0(Container_t[] result){
	     result[0] = new Container_t("/AddressRoot", Long.valueOf(1), new String[] {}, new MapBuilder<String, Object>().build(), Set.of());
	...
	private Model_t da = new Model_t (
		...
		null,
	    // additional Values:
	    new MapBuilder<String, Object>().put("BaseYear", null).put("TimeZone", "UTC").put("ModelId", "Address").put("Annotation", new MapBuilder<String, Object>().put("roles", "admin,guest,ModelRead").build()).build(),
	...
	private Meta_address() {
	    ...
	    meta = new MetaModelImpl(
					...
					ERValidator_address::getInstance);
		...
		Meta_PfFeld_address metaPlfFeldInfo = new Meta_PfFeld_address (getMetaDataValidierung());
