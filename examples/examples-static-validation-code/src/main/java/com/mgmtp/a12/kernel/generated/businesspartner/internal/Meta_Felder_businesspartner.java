...
public class Meta_Felder_businesspartner {
	...
	public ArrayList<Feld_t> getFelder(){
 	...
 	felder.add(new Feld_t(11, "income_0", "/BusinessPartnerRoot/Employment/income", 1, false, false, metaFormate.get(5), "businesspartnerincome_0Validate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Income").put(new Locale("de"), "Einkommen").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(11)));
 	felder.add(new Feld_t(12, "tax", "/BusinessPartnerRoot/Employment/tax", 1, false, false, metaFormate.get(5), "businesspartnertaxValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "tax").put(new Locale("de"), "Steuer").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(12)));
 	felder.add(new Feld_t(13, "role_0", "/BusinessPartnerRoot/Employment/role", 1, false, false, metaFormate.get(0), "businesspartnerrole_0Validate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Role").put(new Locale("de"), "Rolle").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(13)));
 	...
 	felder.add(new Feld_t(15, "Discount", "/BusinessPartnerRoot/Offer/Discount", 1, false, false, metaFormate.get(7), "businesspartnerDiscountValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Customer Discount").put(new Locale("de"), "Kundenrabatt").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(15)));
 	...
 	felder.add(new Feld_t(19, "Name", "/BusinessPartnerRoot/Name", 1, true, false, metaFormate.get(0), "businesspartnerNameValidate", new Integer[] { 0}, new Integer[] { 0 }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Name").put(new Locale("de"), "Name").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(19)));
 	felder.add(new Feld_t(20, "Industry", "/BusinessPartnerRoot/Industry", 1, true, false, metaFormate.get(11), "businesspartnerIndustryValidate", new Integer[] { 0}, new Integer[] { 0 }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Industry or business sector").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(20)));
 	felder.add(new Feld_t(21, "role_1", "/BusinessPartnerRoot/role", 1, false, false, metaFormate.get(0), "businesspartnerrole_1Validate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Role").put(new Locale("de"), "Rolle").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(21)));
 	felder.add(new Feld_t(22, "income_1", "/BusinessPartnerRoot/income", 1, false, false, metaFormate.get(2), "businesspartnerincome_1Validate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Income").put(new Locale("de"), "Einkommen").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(22)));
 	felder.add(new Feld_t(23, "EndOfRelationship", "/BusinessPartnerRoot/EndOfRelationship", 1, false, false, metaFormate.get(3), "businesspartnerEndOfRelationshipValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "End of business relationship").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(23)));
 	felder.add(new Feld_t(24, "TimeOfContractSignature", "/BusinessPartnerRoot/TimeOfContractSignature", 1, false, false, metaFormate.get(12), "businesspartnerTimeOfContractSignatureValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Exact time of contract signature").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(24)));
 	...
 	felder.add(new Feld_t(28, "CustomerDiscount", "/BusinessPartnerRoot/CustomerDiscount", 1, true, false, metaFormate.get(16), "businesspartnerCustomerDiscountValidate", new Integer[] { 0}, new Integer[] { 0 }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Customer Discount").put(new Locale("de"), "Kundenrabatt").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(28)));
 	felder.add(new Feld_t(29, "PersonOrEntity", "/BusinessPartnerRoot/PersonOrEntity", 1, false, false, metaFormate.get(0), "businesspartnerPersonOrEntityValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Natural Person or Legal Entity").put(new Locale("de"), "Natürliche Person oder juristische Person").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(29)));
 	felder.add(new Feld_t(30, "Company", "/BusinessPartnerRoot/SubtypeGroup/Company", 1, false, false, metaFormate.get(0), "businesspartnerCompanyValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Company").put(new Locale("de"), "Unternehmen").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(30)));
 	felder.add(new Feld_t(31, "Notes", "/BusinessPartnerRoot/Notes", 1, false, false, metaFormate.get(0), "businesspartnerNotesValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Notes").put(new Locale("de"), "Notizen").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).put("Annotation", new MapBuilder<String, Object>().put("indexed", "false").build()).build(), Set.of(), false, null, null, errorTexts4Req.get(31)));
 	felder.add(new Feld_t(32, "docRef", "/__meta/docRef", 1, false, false, metaFormate.get(0), "businesspartnerdocRefValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Document Reference").put(new Locale("de"), "Dokumentreferenz").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(32)));
 	felder.add(new Feld_t(33, "modelReference", "/__meta/modelReference", 1, false, false, metaFormate.get(0), "businesspartnermodelReferenceValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Document Model Reference").put(new Locale("de"), "Document Model-Referenz").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(33)));
 	felder.add(new Feld_t(34, "modelVersion", "/__meta/modelVersion", 1, false, false, metaFormate.get(0), "businesspartnermodelVersionValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Model Version").put(new Locale("de"), "Model-Version").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(34)));
 	felder.add(new Feld_t(35, "creator", "/__meta/creator", 1, false, false, metaFormate.get(0), "businesspartnercreatorValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Creator").put(new Locale("de"), "Erstellt von").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(35)));
 	felder.add(new Feld_t(36, "createdAt", "/__meta/createdAt", 1, false, false, metaFormate.get(3), "businesspartnercreatedAtValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Created At").put(new Locale("de"), "Erstellt am").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(36)));
 	felder.add(new Feld_t(37, "modifier", "/__meta/modifier", 1, false, false, metaFormate.get(0), "businesspartnermodifierValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Modifier").put(new Locale("de"), "Bearbeitet von").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(37)));
 	felder.add(new Feld_t(38, "modifiedAt", "/__meta/modifiedAt", 1, false, false, metaFormate.get(3), "businesspartnermodifiedAtValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(new Locale("en"), "Modified At").put(new Locale("de"), "Bearbeitet am").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(38)));
 	}
 	...
 	enumerationOberflaechenWerte.get(7).put(new Locale("de"), MetaFeldUtil.createPairList(new String[] { "0%_Rabbat", "10%_Rabbat", "20%_Rabbat", "30%_Rabbat", "40%_Rabbat", "50%_Rabbat" }, new String[] { "0%", "10%", "20%", "30%", "40%", "50%" }));
 	enumerationOberflaechenWerte.get(7).put(new Locale("en"), MetaFeldUtil.createPairList(new String[] { "0%_Discount", "10%_Discount", "20%_Discount", "30%_Discount", "40%_Discount", "50%_Discount" }, new String[] { "0%", "10%", "20%", "30%", "40%", "50%" }));
 	...
 	enumerationOberflaechenWerte.get(11).put(new Locale("de"), MetaFeldUtil.createPairList(new String[] { "Informationstechnologie", "Bankwesen", "Buchhaltung", "Gesundheitswesen", "Versicherung", "Gesetzlich", "Handel" }, new String[] { "IT", "Banking", "Accountancy", "Healthcare", "Risk", "Legal", "Commerce" }));
 	enumerationOberflaechenWerte.get(11).put(new Locale("en"), MetaFeldUtil.createPairList(new String[] { "Information Technology", "Banking", "Accountancy", "Healthcare", "Risk", "Legal", "Commerce" }, new String[] { "IT", "Banking", "Accountancy", "Healthcare", "Risk", "Legal", "Commerce" }));
 	...
 	enumerationOberflaechenWerte.get(16).put(new Locale("de"), MetaFeldUtil.createPairList(new String[] { "0%_Rabbat", "10%_Rabbat", "20%_Rabbat", "30%_Rabbat", "40%_Rabbat", "50%_Rabbat", "60%_Rabbat", "70%_Rabbat", "80%_Rabbat", "90%_Rabbat" }, new String[] { "100%", "90%", "80%", "70%", "60%", "50%", "40%", "30%", "20%", "10%" }));
 	enumerationOberflaechenWerte.get(16).put(new Locale("en"), MetaFeldUtil.createPairList(new String[] { "0%_Discount", "10%_Discount", "20%_Discount", "30%_Discount", "40%_Discount", "50%_Discount", "60%_Discount", "70%_Discount", "80%_Discount", "90%_Discount" }, new String[] { "100%", "90%", "80%", "70%", "60%", "50%", "40%", "30%", "20%", "10%" }));
