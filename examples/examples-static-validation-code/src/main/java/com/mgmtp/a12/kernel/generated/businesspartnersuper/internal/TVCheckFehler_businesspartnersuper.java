 ...
 *  
 */
public class TVCheckFehler_businesspartnersuper implements ITeilValidierungChecker {

	private R_businesspartnersuper checkObject = R_businesspartnersuper.getInstance();

	public TVCheckFehler_businesspartnersuper() {
	}
