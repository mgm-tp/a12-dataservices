 ...
 *  
 */
public class TVCheckPreliminary_contractcdm implements ITeilValidierungChecker {

	private R_contractcdm checkObject = R_contractcdm.getInstance();

	public TVCheckPreliminary_contractcdm() {
	}
