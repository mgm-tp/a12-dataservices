 ...
 *
 */
public class  Meta_PfFeld_businesspartner {

    private final IMetaDataValidierung metaDataValidierung;

    Meta_PfFeld_businesspartner(IMetaDataValidierung metaDataValidierung) {
    ...
    void addLokalePflichtFeldInfos(Set<MetaLokalePflichtInfo> additivUndPflichtfelder) {
        ...
        for (String [] info : infos) {
            addLokalePflichtFeldInfo(
                    ...
                    info[0],
                    info[1],
                    Meta_businesspartner.getMetaFSMenge(info[2]),
                    Meta_businesspartner.getMetaFSMenge(info[3]));
        }
