...
public class Meta_contract implements IMetaModel, IMetaEntityInternal {
    ...
    private static final Meta_contract instance = new Meta_contract();

	static {
	}

    public static Meta_contract getInstance() {
        return instance;
    }
	...
	private Meta_contract() {
	    ...
	    meta = new MetaModelImpl(
					...
					ERValidator_contract::getInstance);
		...
		Meta_PfFeld_contract metaPlfFeldInfo = new Meta_PfFeld_contract (getMetaDataValidierung());
