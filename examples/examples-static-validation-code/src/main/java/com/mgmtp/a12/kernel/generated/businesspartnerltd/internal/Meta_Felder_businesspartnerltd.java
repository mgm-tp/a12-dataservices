...
public class Meta_Felder_businesspartnerltd {
	...
	public ArrayList<Feld_t> getFelder(){
 	...
 	felder.add(new Feld_t(8, "Name", "/BusinessPartnerRoot/Name", 1, true, false, metaFormate.get(0), "businesspartnerltdNameValidate", new Integer[] { 0}, new Integer[] { 0 }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(Locale.of("en"), "Name").put(Locale.of("de"), "Name").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(8)));
 	felder.add(new Feld_t(9, "Industry", "/BusinessPartnerRoot/Industry", 1, true, false, metaFormate.get(3), "businesspartnerltdIndustryValidate", new Integer[] { 0}, new Integer[] { 0 }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(Locale.of("en"), "Industry or business sector").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(9)));
 	...
 	felder.add(new Feld_t(11, "income", "/BusinessPartnerRoot/Employment/income", 1, false, false, metaFormate.get(5), "businesspartnerltdincomeValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(Locale.of("en"), "Income").put(Locale.of("de"), "Einkommen").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(11)));
 	felder.add(new Feld_t(12, "tax", "/BusinessPartnerRoot/Employment/tax", 1, false, false, metaFormate.get(5), "businesspartnerltdtaxValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(Locale.of("en"), "tax").put(Locale.of("de"), "Steuer").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(12)));
 	felder.add(new Feld_t(13, "CustomerDiscount", "/BusinessPartnerRoot/CustomerDiscount", 1, true, false, metaFormate.get(6), "businesspartnerltdCustomerDiscountValidate", new Integer[] { 0}, new Integer[] { 0 }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(Locale.of("en"), "Customer Discount").put(Locale.of("de"), "Kundenrabatt").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(13)));
 	felder.add(new Feld_t(14, "PersonOrEntity", "/BusinessPartnerRoot/PersonOrEntity", 1, false, false, metaFormate.get(0), "businesspartnerltdPersonOrEntityValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(Locale.of("en"), "Natural Person or Legal Entity").put(Locale.of("de"), "Natürliche Person oder juristische Person").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(14)));
 	felder.add(new Feld_t(15, "Type", "/BusinessPartnerRoot/SubtypeGroup/Type", 1, false, false, metaFormate.get(7), "businesspartnerltdTypeValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(Locale.of("en"), "Type of Legal Entity").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(15)));
 	felder.add(new Feld_t(16, "docRef", "/__meta/docRef", 1, false, false, metaFormate.get(0), "businesspartnerltddocRefValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(Locale.of("en"), "Document Reference").put(Locale.of("de"), "Dokumentreferenz").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(16)));
 	felder.add(new Feld_t(17, "modelReference", "/__meta/modelReference", 1, false, false, metaFormate.get(0), "businesspartnerltdmodelReferenceValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(Locale.of("en"), "Document Model Reference").put(Locale.of("de"), "Document Model-Referenz").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(17)));
 	felder.add(new Feld_t(18, "modelVersion", "/__meta/modelVersion", 1, false, false, metaFormate.get(0), "businesspartnerltdmodelVersionValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(Locale.of("en"), "Model Version").put(Locale.of("de"), "Model-Version").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(18)));
 	felder.add(new Feld_t(19, "creator", "/__meta/creator", 1, false, false, metaFormate.get(0), "businesspartnerltdcreatorValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(Locale.of("en"), "Creator").put(Locale.of("de"), "Erstellt von").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(19)));
 	felder.add(new Feld_t(20, "createdAt", "/__meta/createdAt", 1, false, false, metaFormate.get(8), "businesspartnerltdcreatedAtValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(Locale.of("en"), "Created At").put(Locale.of("de"), "Erstellt am").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(20)));
 	felder.add(new Feld_t(21, "modifier", "/__meta/modifier", 1, false, false, metaFormate.get(0), "businesspartnerltdmodifierValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(Locale.of("en"), "Modifier").put(Locale.of("de"), "Bearbeitet von").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(21)));
 	felder.add(new Feld_t(22, "modifiedAt", "/__meta/modifiedAt", 1, false, false, metaFormate.get(8), "businesspartnerltdmodifiedAtValidate", new Integer[] { }, new Integer[] {  }, new MapBuilder<String, Object>().put("DruckText", new MapBuilder<Locale, String>().put(Locale.of("en"), "Modified At").put(Locale.of("de"), "Bearbeitet am").build()).put("GlobalesFeld", false).put("ExplicitlyMandatory", false).put("TransientField", false).put("IndexField", false).build(), Set.of(), false, null, null, errorTexts4Req.get(22)));
 	}
 	...
 	enumerationOberflaechenWerte.get(6).put(Locale.of("de"), MetaFeldUtil.createPairList(new String[] { "0%_Rabbat", "10%_Rabbat", "20%_Rabbat", "30%_Rabbat", "40%_Rabbat", "50%_Rabbat", "60%_Rabbat", "70%_Rabbat", "80%_Rabbat", "90%_Rabbat" }, new String[] { "100%", "90%", "80%", "70%", "60%", "50%", "40%", "30%", "20%", "10%" }));
 	enumerationOberflaechenWerte.get(6).put(Locale.of("en"), MetaFeldUtil.createPairList(new String[] { "0%_Discount", "10%_Discount", "20%_Discount", "30%_Discount", "40%_Discount", "50%_Discount", "60%_Discount", "70%_Discount", "80%_Discount", "90%_Discount" }, new String[] { "100%", "90%", "80%", "70%", "60%", "50%", "40%", "30%", "20%", "10%" }));
 	...
 	enumerationOberflaechenWerte.get(7).put(Locale.of("de"), MetaFeldUtil.createPairList(new String[] { "GmbH", "AG", "KG", "PLC", "LLC" }, new String[] { "GmbH", "AG", "KG", "PLC", "LLC" }));
 	enumerationOberflaechenWerte.get(7).put(Locale.of("en"), MetaFeldUtil.createPairList(new String[] { "GmbH", "AG", "KG", "PLC", "LLC" }, new String[] { "GmbH", "AG", "KG", "PLC", "LLC" }));
