 ...
 *
 */
public class  Meta_PfFeld_contractcdm {

    private final IMetaDataValidierung metaDataValidierung;

    Meta_PfFeld_contractcdm(IMetaDataValidierung metaDataValidierung) {
    ...
    void addLokalePflichtFeldInfos(Set<MetaLokalePflichtInfo> additivUndPflichtfelder) {
        ...
        for (String [] info : infos) {
            addLokalePflichtFeldInfo(
                    ...
                    info[0],
                    info[1],
                    Meta_contractcdm.getMetaFSMenge(info[2]),
                    Meta_contractcdm.getMetaFSMenge(info[3]));
        }
