...
public class Meta_businesspartnersuper implements IMetaModel, IMetaEntityInternal {
    ...
    private static final Meta_businesspartnersuper instance = new Meta_businesspartnersuper();

	static {
	}

    public static Meta_businesspartnersuper getInstance() {
        return instance;
    }
	...
	private static void initContainer_0(Container_t[] result){
	     ...
	     result[3] = new Container_t("/__meta", Long.valueOf(1), new String[] {}, new MapBuilder<String, Object>().build(), Set.of());
	     result[4] = new Container_t("/__meta/extensions", Long.valueOf(1), new String[] {}, new MapBuilder<String, Object>().build(), Set.of());
	}


	static Container_t[] initContainer() {
		Container_t[] result = new Container_t[5];
	...
	private Model_t da = new Model_t (
		...
		null,
	    // additional Values:
	    new MapBuilder<String, Object>().put("BaseYear", null).put("TimeZone", "UTC").put("ModelId", "BusinessPartnerSuper").put("Annotation", new MapBuilder<String, Object>().put("roles", "admin,guest,ModelRead").put("abstract", "true").put("subTypes", "BusinessPartner,BusinessPartnerLTD").build()).build(),
	...
	private Meta_businesspartnersuper() {
	    ...
	    meta = new MetaModelImpl(
					...
					ERValidator_businesspartnersuper::getInstance);
		...
		Meta_PfFeld_businesspartnersuper metaPlfFeldInfo = new Meta_PfFeld_businesspartnersuper (getMetaDataValidierung());
