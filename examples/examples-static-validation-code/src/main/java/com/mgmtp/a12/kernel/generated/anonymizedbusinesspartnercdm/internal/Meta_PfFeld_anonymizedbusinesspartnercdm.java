 ...
 *
 */
public class  Meta_PfFeld_anonymizedbusinesspartnercdm {

    private final IMetaDataValidierung metaDataValidierung;

    Meta_PfFeld_anonymizedbusinesspartnercdm(IMetaDataValidierung metaDataValidierung) {
    ...
    void addLokalePflichtFeldInfos(Set<MetaLokalePflichtInfo> additivUndPflichtfelder) {
        ...
        for (String [] info : infos) {
            addLokalePflichtFeldInfo(
                    ...
                    info[0],
                    info[1],
                    Meta_anonymizedbusinesspartnercdm.getMetaFSMenge(info[2]),
                    Meta_anonymizedbusinesspartnercdm.getMetaFSMenge(info[3]));
        }
