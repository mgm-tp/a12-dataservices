...
public class Meta_recursivebusinesspartnercdm implements IMetaModel, IMetaEntityInternal {
    ...
    private final List<Locale> unterstuetzteSprachen = Arrays.asList( new Locale("en"), new Locale("de") );
	...
	private Model_t da = new Model_t (
	    ...
	    '.', //dezimaltrenner
		Arrays.asList( new Locale("en"), new Locale("de") ), // unterstuetzte Sprachen
