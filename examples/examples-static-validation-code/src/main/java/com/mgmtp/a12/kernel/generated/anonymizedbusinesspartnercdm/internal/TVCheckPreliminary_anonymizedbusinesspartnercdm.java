 ...
 *  
 */
public class TVCheckPreliminary_anonymizedbusinesspartnercdm implements ITeilValidierungChecker {

	private R_anonymizedbusinesspartnercdm checkObject = R_anonymizedbusinesspartnercdm.getInstance();

	public TVCheckPreliminary_anonymizedbusinesspartnercdm() {
	}
