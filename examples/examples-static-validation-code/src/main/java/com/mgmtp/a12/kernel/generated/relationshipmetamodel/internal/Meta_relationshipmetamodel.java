...
public class Meta_relationshipmetamodel implements IMetaModel, IMetaEntityInternal {
    ...
    private Meta_Felder_relationshipmetamodel metaFelder = new Meta_Felder_relationshipmetamodel();
    private Meta_Regel_relationshipmetamodel metaRegeln = new Meta_Regel_relationshipmetamodel();
    private final List<Locale> unterstuetzteSprachen = Arrays.asList( Locale.of("en") );

    private static final Map<Locale, PresentationInformationValues> DEFAULT_PRESENTATION_INFO = new MapBuilder<Locale, PresentationInformationValues>().put(Locale.of("en"), new PresentationInformationValues(".", ",", "-", "JMT", PresentationInformation.FALSE, "~", "MM/dd/yyyy HH:mm", "HH:mm")).build();
    ...
    private static final Meta_relationshipmetamodel instance = new Meta_relationshipmetamodel();

	static {
	}

    public static Meta_relationshipmetamodel getInstance() {
        return instance;
    }
	...
	private static void initContainer_0(Container_t[] result){
	     result[0] = new Container_t("/header", Long.valueOf(1), new String[] {}, new MapBuilder<String, Object>().build(), Set.of());
	     result[1] = new Container_t("/header/locales", Long.valueOf(9999), new String[] {"code", }, new MapBuilder<String, Object>().build(), Set.of());
	     result[2] = new Container_t("/header/labels", Long.valueOf(9999), new String[] {"locale", }, new MapBuilder<String, Object>().build(), Set.of());
	     result[3] = new Container_t("/header/annotations", Long.valueOf(9999), new String[] {"name", }, new MapBuilder<String, Object>().build(), Set.of());
	     result[4] = new Container_t("/header/modelReferences", Long.valueOf(9999), new String[] {}, new MapBuilder<String, Object>().build(), Set.of());
	     result[5] = new Container_t("/content", Long.valueOf(1), new String[] {}, new MapBuilder<String, Object>().build(), Set.of());
	     result[6] = new Container_t("/content/labels", Long.valueOf(9999), new String[] {"locale", }, new MapBuilder<String, Object>().build(), Set.of());
	     result[7] = new Container_t("/content/entityCharacteristics", Long.valueOf(2), new String[] {}, new MapBuilder<String, Object>().build(), Set.of());
	     result[8] = new Container_t("/content/entityCharacteristics/labels", Long.valueOf(999), new String[] {}, new MapBuilder<String, Object>().build(), Set.of());
	     result[9] = new Container_t("/content/entityCharacteristics/linkConstraints", Long.valueOf(1), new String[] {}, new MapBuilder<String, Object>().build(), Set.of());
	     result[10] = new Container_t("/content/entityCharacteristics/linkConstraints/multiplicity", Long.valueOf(1), new String[] {}, new MapBuilder<String, Object>().build(), Set.of());
	}


	static Container_t[] initContainer() {
		Container_t[] result = new Container_t[11];
	...
	private Model_t da = new Model_t (
	    ...
	    '.', //dezimaltrenner
		Arrays.asList( Locale.of("en") ), // unterstuetzte Sprachen
		...
		null,
	    // additional Values:
	    new MapBuilder<String, Object>().put("BaseYear", null).put("TimeZone", "UTC").put("ModelId", "RelationshipMetaModel").put("Annotation", new MapBuilder<String, Object>().put("roles", "guest,admin,systemAdmin").build()).build(),
	...
	private Meta_relationshipmetamodel() {
	    ...
	    meta = new MetaModelImpl(
					...
					ERValidator_relationshipmetamodel::getInstance);
		...
		Meta_PfFeld_relationshipmetamodel metaPlfFeldInfo = new Meta_PfFeld_relationshipmetamodel (getMetaDataValidierung());
