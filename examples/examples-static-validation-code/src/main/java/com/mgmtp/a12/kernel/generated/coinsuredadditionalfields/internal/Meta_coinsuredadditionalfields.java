...
public class Meta_coinsuredadditionalfields implements IMetaModel, IMetaEntityInternal {
    ...
    private Meta_Felder_coinsuredadditionalfields metaFelder = new Meta_Felder_coinsuredadditionalfields();
    private Meta_Regel_coinsuredadditionalfields metaRegeln = new Meta_Regel_coinsuredadditionalfields();
    ...
    private static final Meta_coinsuredadditionalfields instance = new Meta_coinsuredadditionalfields();

	static {
	}

    public static Meta_coinsuredadditionalfields getInstance() {
        return instance;
    }
	...
	private static void initContainer_0(Container_t[] result){
	     result[0] = new Container_t("/CoInsuredRoot", Long.valueOf(1), new String[] {}, new MapBuilder<String, Object>().build(), Set.of());
	...
	private Model_t da = new Model_t (
		...
		null,
	    // additional Values:
	    new MapBuilder<String, Object>().put("BaseYear", null).put("TimeZone", "UTC").put("ModelId", "CoInsuredAdditionalFields").put("Annotation", new MapBuilder<String, Object>().put("roles", "admin,guest").build()).build(),
	...
	private Meta_coinsuredadditionalfields() {
	    ...
	    meta = new MetaModelImpl(
					...
					ERValidator_coinsuredadditionalfields::getInstance);
		...
		Meta_PfFeld_coinsuredadditionalfields metaPlfFeldInfo = new Meta_PfFeld_coinsuredadditionalfields (getMetaDataValidierung());
