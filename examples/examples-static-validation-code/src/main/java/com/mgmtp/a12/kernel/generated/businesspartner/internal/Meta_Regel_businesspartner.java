...
public class  Meta_Regel_businesspartner {
	...
	// Init Daten zur Regel '/BusinessPartnerRoot/NameFilled'
	mehrsprachigeFehlertexte.get(5).put(Locale.of("de"), "Interner Fehler: Name muss ausgefüllt sein.");
	mehrsprachigeFehlertexte.get(5).put(Locale.of("en"), "Internal Error: Name must be filled.");

	// Init Daten zur Regel '/BusinessPartnerRoot/IndustryFilled'
	mehrsprachigeFehlertexte.get(6).put(Locale.of("de"), "Interner Fehler: Industry muss ausgefüllt sein.");
	mehrsprachigeFehlertexte.get(6).put(Locale.of("en"), "Internal Error: Industry must be filled.");
	...
	mehrsprachigeFehlertexte.get(8).put(Locale.of("en"), "error text for computation of PersonComp");
