 ...
 *
 */
public class  Meta_Regel_businesspartner {
	...
	{
	    // filter (decl & refs) omitted for referenced entities
	  	final RtIdentifierTemplate metaRule4RefsrtIdCon1 = RtIdentifierTemplate.builder().unqNm("income_0").isField(true).usb(-2).idx(1).idx(1).idx(1).build();
	...
	refIdentifier[5] = new Identifier_t[]{
			new Identifier_t( 19, new long[]{1, 1}, IIdentifier.USB_NOT_SPECIFIED, ReferenzTyp.KEINE_BERECHNUNG, null, null, "/BusinessPartnerRoot/Name")
	};
	...
	{
	    // filter (decl & refs) omitted for referenced entities
	  	final RtIdentifierTemplate metaRule5RefsrtIdCon1 = RtIdentifierTemplate.builder().unqNm("Name").isField(true).usb(-2).idx(1).idx(1).build();
	...
	refIdentifier[6] = new Identifier_t[]{
			new Identifier_t( 20, new long[]{1, 1}, IIdentifier.USB_NOT_SPECIFIED, ReferenzTyp.KEINE_BERECHNUNG, null, null, "/BusinessPartnerRoot/Industry")
	};
	...
	{
	    // filter (decl & refs) omitted for referenced entities
	  	final RtIdentifierTemplate metaRule6RefsrtIdCon1 = RtIdentifierTemplate.builder().unqNm("Industry").isField(true).usb(-2).idx(1).idx(1).build();
	...
	refIdentifier[7] = new Identifier_t[]{
			new Identifier_t( 28, new long[]{1, 1}, IIdentifier.USB_NOT_SPECIFIED, ReferenzTyp.KEINE_BERECHNUNG, null, null, "/BusinessPartnerRoot/CustomerDiscount")
	};
	...
	refIdentifier[8] = new Identifier_t[]{
			new Identifier_t( 19, new long[]{1, 1}, IIdentifier.USB_NOT_SPECIFIED, ReferenzTyp.KEINE_BERECHNUNG, null, null, "/BusinessPartnerRoot/Name"),
			new Identifier_t( 20, new long[]{1, 1}, IIdentifier.USB_NOT_SPECIFIED, ReferenzTyp.KEINE_BERECHNUNG, null, null, "/BusinessPartnerRoot/Industry"),
			new Identifier_t( 27, new long[]{1, 1}, IIdentifier.USB_NOT_SPECIFIED, ReferenzTyp.KEINE_BERECHNUNG, null, null, "/BusinessPartnerRoot/StartOfRelationship"),
			new Identifier_t( 28, new long[]{1, 1}, IIdentifier.USB_NOT_SPECIFIED, ReferenzTyp.KEINE_BERECHNUNG, null, null, "/BusinessPartnerRoot/CustomerDiscount"),
			new Identifier_t( 29, new long[]{1, 1}, IIdentifier.USB_NOT_SPECIFIED, ReferenzTyp.KEINE_BERECHNUNG, null, null, "/BusinessPartnerRoot/PersonOrEntity")
	};
	...
	// Init Daten zur Regel '/BusinessPartnerRoot/NameFilled'
	mehrsprachigeFehlertexte.get(5).put(new Locale("de"), "Interner Fehler: Name muss ausgefüllt sein.");
	mehrsprachigeFehlertexte.get(5).put(new Locale("en"), "Internal Error: Name must be filled.");

	// Init Daten zur Regel '/BusinessPartnerRoot/IndustryFilled'
	mehrsprachigeFehlertexte.get(6).put(new Locale("de"), "Interner Fehler: Industry muss ausgefüllt sein.");
	mehrsprachigeFehlertexte.get(6).put(new Locale("en"), "Internal Error: Industry must be filled.");
	...
	mehrsprachigeFehlertexte.get(8).put(new Locale("en"), "error text for computation of PersonComp");
	...
	regeln.add(new Regel_t("NameFilled", "/BusinessPartnerRoot/NameFilled", "ErrorR33", mehrsprachigeFehlertexte.get(5), "Fehler", refIdentifier[5], refAuslassungsIdentifier[5], refEntity[5], refAuslassungsEntity[5], null,"/BusinessPartnerRoot/Name", false, false, new MapBuilder<String, Object>().build(), Set.of()));
	regeln.add(new Regel_t("IndustryFilled", "/BusinessPartnerRoot/IndustryFilled", "ErrorR34", mehrsprachigeFehlertexte.get(6), "Fehler", refIdentifier[6], refAuslassungsIdentifier[6], refEntity[6], refAuslassungsEntity[6], null,"/BusinessPartnerRoot/Industry", false, false, new MapBuilder<String, Object>().build(), Set.of()));
	...
	regeln.add(new Regel_t("PersonComp", "/BusinessPartnerRoot/SubtypeGroup/PersonComp", "PersonComp", mehrsprachigeFehlertexte.get(8), "Fehler", refIdentifier[8], refAuslassungsIdentifier[8], refEntity[8], refAuslassungsEntity[8], null,"/BusinessPartnerRoot/PersonOrEntity", true, false, new MapBuilder<String, Object>().build(), Set.of()));
	}


  	public Meta_Regel_businesspartner() {
        initRegelRefs_0();
