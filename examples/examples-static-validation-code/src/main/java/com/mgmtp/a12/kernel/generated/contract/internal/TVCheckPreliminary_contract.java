 ...
 *  
 */
public class TVCheckPreliminary_contract implements ITeilValidierungChecker {

	private R_contract checkObject = R_contract.getInstance();

	public TVCheckPreliminary_contract() {
	}
