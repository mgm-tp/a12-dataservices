...
public class RelationshipLinkFactoryTest extends AbstractDataServicesCoreTest {
	...
	@InjectMocks private RelationshipLinkFactory relationshipLinkFactory;

	@Test void testCreateLinkWithNoComputedRank() {
	...
	@Test void testCreateLinkWithExistedComputedRank() {
		Mockito.reset(relationshipRankService, relationshipValidationSupport);
		LinkDescriptor mockedLinkDescriptor = mockLinkDescriptor();
