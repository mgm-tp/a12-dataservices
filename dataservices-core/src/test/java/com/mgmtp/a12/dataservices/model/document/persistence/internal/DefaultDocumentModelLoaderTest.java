...
public class DefaultDocumentModelLoaderTest extends AbstractDataServicesCoreTest {
	...
	@InjectMocks private DefaultDocumentModelLoader defaultDocumentModelLoader;
	...
	void testLoadModel_shouldLoadSuccessfully() {
		...
		IDocumentModel result = defaultDocumentModelLoader.loadModel(modelId);
	...
	public void shouldImplementIDocumentModelLoaderInterface() {
		assertThat(defaultDocumentModelLoader).isInstanceOf(DocumentModelLoader.class);
	}
}
