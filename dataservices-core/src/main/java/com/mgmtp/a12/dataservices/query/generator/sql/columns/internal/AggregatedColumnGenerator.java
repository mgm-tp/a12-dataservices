...
@SuperBuilder
public class AggregatedColumnGenerator extends AbstractTopologyColumnGenerator {

	@Delegate(types = GeneratedColumns.class)
	private final AbstractTopologyColumnGenerator delegate;

	@Override public CharSequence getDocRefValue() {
		return "('_generated_aggregation/' || floor(random() * 100000000000000) + 1)";
	}

	@Override public CharSequence getContentValue(QueryGeneratorContext generatorContext) {
		return QueryGeneratorConstants.ColumnNames.CONTENT_COLUMN_ALIAS;
	}
