...
@Component public class GenericModelPermissionEvaluator extends AbstractModelPermissionEvaluator<GenericModel> {

	public GenericModelPermissionEvaluator(AuthorizationService authorizationService, CachedPermissionEvaluator cachedPermissionEvaluator,
