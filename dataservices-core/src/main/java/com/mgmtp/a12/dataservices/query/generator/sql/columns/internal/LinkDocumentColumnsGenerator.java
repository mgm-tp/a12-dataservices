...
@SuperBuilder
public class LinkDocumentColumnsGenerator extends AbstractLinkColumnsGenerator {
	...
	@Override public CharSequence getTypeValue() {
		return SqlGeneratorHelpers.addParam(QueryGeneratorConstants.NodeType.LINK_TYPE, getQueryGeneratorContext());
	}
	...
	@Override public CharSequence getContentValue(QueryGeneratorContext generatorContext) {
		...
		return DocumentProjectionImplementation.PROJECTION_NAME.equals(generatorContext.getProjectionName()) && CollectionUtils.isEmpty(getQuery().getLinkDocumentFields()) ?
			null :
