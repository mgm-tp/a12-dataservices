...
/**
 * Abstract Relationship Link Event class serves as base class for all events related to relationship links mutations (creation, deletion, update).
 *
 */
@Getter @AllArgsConstructor @EqualsAndHashCode
public abstract class AbstractRelationshipLinkEvent {

	private RelationshipModel relationshipModel;
	private RelationshipLink link;
