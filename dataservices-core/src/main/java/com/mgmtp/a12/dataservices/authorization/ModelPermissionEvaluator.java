 ...
 * ----
 * {@literal @}Autowired
 * ModelPermissionEvaluator<IDocumentModel> documentModelPermissionEvaluator;
 * ----
 * [source,java]
 * ----
 * {@literal @}Autowired
 * ModelPermissionEvaluator<RelationshipModel> relationshipModelPermissionEvaluator;
 * ----
 *
 * @param <T> presents different type of model.
 * @see com.mgmtp.a12.dataservices.authorization.internal.DefaultModelPermissionEvaluator
 * @see com.mgmtp.a12.dataservices.authorization.internal.ComposeDocumentModelPermissionEvaluator
 * @see com.mgmtp.a12.dataservices.authorization.internal.DefaultDocumentModelPermissionEvaluator
 * @see com.mgmtp.a12.dataservices.authorization.internal.GenericModelPermissionEvaluator
 * @see com.mgmtp.a12.dataservices.authorization.internal.RelationshipModelPermissionEvaluator
 */
public interface ModelPermissionEvaluator<T extends Model> {
