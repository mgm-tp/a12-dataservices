...
/**
 * Repository for reading {@link GenericModel} instances without type filtering.
...
@Component public class GenericModelReadRepository extends AbstractModelReadRepository<GenericModel> {
	...
	@Override protected GenericModel buildModelFromHeaderAndContent(@NonNull Header header, @NonNull String modelContent) {
		return GenericModel.of(header, modelContent);
	}
