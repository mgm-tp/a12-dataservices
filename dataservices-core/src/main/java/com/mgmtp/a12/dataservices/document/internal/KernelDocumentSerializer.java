...
@Component public class KernelDocumentSerializer extends StdSerializer<DocumentV2> {
	...
	private final transient IDocumentV2Serializer documentSerializer;
	private final transient DocumentSerializationConfig documentJsonSerializationConfig;

	public KernelDocumentSerializer(IDocumentV2Serializer documentSerializer, DocumentSerializationConfig documentJsonSerializationConfig) {
		super(DocumentV2.class);
