...
@SuperBuilder
public class RootColumnGenerator extends AbstractTopologyColumnGenerator {

	@Override public CharSequence getTypeValue() {
		return SqlGeneratorHelpers.addParam(QueryGeneratorConstants.NodeType.ROOT_TYPE, getQueryGeneratorContext());
	}
	...
	@Override public CharSequence getCountValue() {
		return QueryGeneratorConstants.ColumnNames.TOTAL_COUNT_COLUMN_ALIAS;
	}
}
