...
/**
 * Allows changes to the query before it is processed by {@link QueryService}.
 * This event is triggered with every QUERY operation. It is not triggered if
 * {@link QueryService} or {@link QueryRepository} are called directly.
 */
@Data
@AllArgsConstructor
@EventDocumentation public final class QueryBeforeOperationEvent {
