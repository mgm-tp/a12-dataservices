 ...
 */
package com.mgmtp.a12.dataservices.rpc.internal.jpa;
...
@Component public class InsecureModelCacheResolver implements CacheResolver {
	...
	@Override public @NonNull Collection<? extends Cache> resolveCaches(CacheOperationInvocationContext<?> context) {
		return cacheMap.computeIfAbsent(ModelCacheManager.UNSECURED_MODEL_READ_CACHE,
			k -> List.of(new ConcurrentMapCache(ModelCacheManager.UNSECURED_MODEL_READ_CACHE)));
	}
