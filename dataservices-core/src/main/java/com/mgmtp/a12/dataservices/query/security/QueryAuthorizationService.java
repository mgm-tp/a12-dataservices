...
public interface QueryAuthorizationService {
	 ...
	 *
	 * @param constraint the constraint to augment with ABAC rules; never null.
	 * @param documentModel the document model ID the rules apply to; never null.
	 * @return the augmented constraint ready for authorization-aware evaluation.
	 */
	ILogicOperator addAbacRules(ILogicOperator constraint, String documentModel);
}
