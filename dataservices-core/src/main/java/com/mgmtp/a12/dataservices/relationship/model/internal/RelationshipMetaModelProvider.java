...
@Component public class RelationshipMetaModelProvider extends AbstractInternalModelProvider {

	public RelationshipMetaModelProvider(DocumentModelUtils documentModelUtils) {
		super(documentModelUtils);
	}

	@Override protected String getModelName() {
		return RelationshipModel.META_MODEL_NAME;
	}

	@Override protected String getModelPath() {
		return RelationshipModel.META_MODEL_JSON_LOCATION;
	}
}
