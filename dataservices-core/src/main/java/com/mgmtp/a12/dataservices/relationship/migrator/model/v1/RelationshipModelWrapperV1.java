...
/**
 * Wrapper for a V1 relationship model including its external identifier.
 *
 * @deprecated Not used anymore, will be removed in the next breaking release.
 */
@Deprecated(since = "38.1.0", forRemoval = true)
@Data public class RelationshipModelWrapperV1 {

	private String id;
	private RelationshipModelV1 relationshipModel;
