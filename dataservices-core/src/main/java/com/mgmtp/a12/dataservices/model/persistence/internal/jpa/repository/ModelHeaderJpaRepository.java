 ...
 */
package com.mgmtp.a12.dataservices.model.persistence.internal.jpa.repository;
...
public interface ModelHeaderJpaRepository extends JpaRepository<ModelHeaderEntity, String> {
	...
	List<Header> findAllByIdIn(Collection<String> modelNames);
