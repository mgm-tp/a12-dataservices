...
@Data
@AllArgsConstructor
@EventDocumentation public final class DocumentBeforeRepositorySaveEvent {

	// Only document model name can be provided because the document ids are generated after create
