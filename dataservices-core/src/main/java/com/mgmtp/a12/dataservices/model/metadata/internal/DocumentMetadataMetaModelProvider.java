...
@Component public class DocumentMetadataMetaModelProvider extends AbstractInternalModelProvider {
	...
	public DocumentMetadataMetaModelProvider(DocumentModelUtils documentModelUtils, DataServicesCoreProperties dataServicesCoreProperties) {
	...
	@Override protected String getModelPath() {
		return dataServicesCoreProperties.getModels().getMetadata().getDocument().getPath();
	}
}
