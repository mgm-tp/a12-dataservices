...
/**
 * Contains attachment annotations as name/value pairs.
 */
...
@Entity public class AttachmentAnnotationEntity implements Serializable {
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "attachment_annotation_seq")
	@Id private Long id;

	@Column private String name;

	@Column private String annotationValue;
