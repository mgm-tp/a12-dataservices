...
import static com.mgmtp.a12.dataservices.query.projection.internal.JsonbCddProjectionImplementation.PROJECTION_NAME;
import static com.mgmtp.a12.dataservices.utils.internal.ComposeDocumentModelUtils.getCrdModelName;

@Slf4j @RequiredArgsConstructor
@QueryProjection(PROJECTION_NAME) public class JsonbCddProjectionImplementation implements IQueryProjection<DocumentSpec> {
	...
	@NotNull private DocumentSpec constructDocumentSpec(QueryContext context, DocumentTreeResult crd, String rootDocumentModel, IDocumentModel cdm,
		...
		try {
			...
			throw new QueryException(ExceptionKeys.ExecutionPhase.QUERY_POSTPROCESSING, ExceptionCodes.QUERY_JSON_PARSING_ERROR_CODE,
				"Wrong CDD JSON generated by the query.", e);
		}
	}
	...
	private String handleComputations(String targetCDMName, String locale, String documentStr, boolean computationsAllowed) throws JsonProcessingException {
