...
public class DefaultDataServicesDocumentMetadataExtractor implements IDataServicesDocumentMetadataExtractor {

	@Override public DataServicesDocumentMetadata getMetadata(DocumentV2 documentV2) {
		return new DefaultDocumentMetadata(documentV2);
	}
}
