...
/**
 * Meta-annotation that configures a Data Services Spring Boot application.
 * Mirrors {@link SpringBootApplication} and exposes selected attributes with Data Services defaults.
 */
@Documented @Inherited @Target(ElementType.TYPE) @Retention(RetentionPolicy.RUNTIME)
@SpringBootApplication
public @interface DataServicesApplication {

	String DATASERVICES_BASE_PACKAGE = "com.mgmtp.a12.dataservices";
	...
	String[] scanBasePackages() default { DataServicesCoreProperties.DS_PACKAGE_PREFIX };
