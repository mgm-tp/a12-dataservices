...
@EventDocumentation public final class RelationshipLinkAfterCreateEvent extends AbstractRelationshipLinkEvent {
	/**
	 * Creates a new event for a newly created relationship link.
	 *
	 * @param relationshipModel The relationship model context; must not be null.
	 * @param link The created link instance; must not be null.
	 */
	public RelationshipLinkAfterCreateEvent(RelationshipModel relationshipModel, RelationshipLink link) {
