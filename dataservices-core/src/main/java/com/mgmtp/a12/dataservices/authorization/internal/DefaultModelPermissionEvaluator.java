...
@Component public class DefaultModelPermissionEvaluator extends AbstractModelPermissionEvaluator<Model> {

	public DefaultModelPermissionEvaluator(AuthorizationService authorizationService, CachedPermissionEvaluator cachedPermissionEvaluator,
