...
/**
 * Mapper class for attachment handling in embedded Content Store.
 */
@Mapper public interface ContentStoreMapper {
	@Mapping(target = "attachmentId", source = "contentId")
	@Mapping(target = "mimeType", source = "contentType")
	AttachmentPersistenceResult toAttachmentPersistenceResult(ContentPersistenceResult attachmentHeader);
}
