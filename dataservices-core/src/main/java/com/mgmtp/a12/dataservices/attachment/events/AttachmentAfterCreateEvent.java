 ...
 */
@Data
@EventDocumentation public final class AttachmentAfterCreateEvent {

	private final DataServicesAttachment dataServicesAttachment;

	/**
	 * Creates the event with the created attachment payload.
	 *
	 * @param dataServicesAttachment The created attachment; must not be null.
	 */
	public AttachmentAfterCreateEvent(DataServicesAttachment dataServicesAttachment) {
		this.dataServicesAttachment = dataServicesAttachment;
	}
}
