 ...
 */
@EventDocumentation public final class RelationshipLinkAfterUpdateEvent extends AbstractRelationshipLinkEvent {

	/**
	 * Creates a new event for an updated relationship link.
	 *
	 * @param relationshipModel The relationship model context; must not be null.
	 * @param link The updated link instance; must not be null.
	 */
	public RelationshipLinkAfterUpdateEvent(RelationshipModel relationshipModel, RelationshipLink link) {
