...
@EventDocumentation public final class CddsAfterLoadByQueryEvent {
	private final List<DataServicesDocument> cdds;

	public CddsAfterLoadByQueryEvent(List<DataServicesDocument> cdds) {
		this.cdds = cdds;
	}
}
