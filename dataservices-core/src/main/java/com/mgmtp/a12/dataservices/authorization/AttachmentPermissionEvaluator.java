...
public interface AttachmentPermissionEvaluator {
	 ...
	 *
	 * @param header The attachment header being evaluated; may be `null`.
	 * @throws AccessDeniedException If the user does not have upload permission.
	 */
	void checkUploadPermission(AttachmentHeader header);
}
