 ...
 */
package com.mgmtp.a12.dataservices.document.operation.validate;
...
/**
 * Wrapper for kernel validation errors outside the API layer.
 * Keeps the Data Services API clean from kernel interfaces to avoid breaking changes.
 */
@Getter
public class ValidateDocumentResult implements Serializable {
	 ...
	 *
	 * @param documentValidationResult the kernel validation result to wrap; must not be null
	 */
