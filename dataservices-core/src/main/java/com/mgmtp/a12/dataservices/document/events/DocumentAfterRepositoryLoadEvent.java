 ...
 */
@Data
@EventDocumentation public final class DocumentAfterRepositoryLoadEvent {

	private DocumentReference documentReference;
	private String documentContent;

	public DocumentAfterRepositoryLoadEvent(DocumentReference documentReference, String documentContent) {
