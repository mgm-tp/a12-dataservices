 ...
 */
@Data
@EventDocumentation public final class ModelAfterRepositoryLoadEvent {
	...
	/**
	 * Constructs an event signaling that a model has been read from the repository layer.
	 *
	 ...
	 * @param modelEntityContent The persisted content as stored in the repository; must not be null.
	 */
	public ModelAfterRepositoryLoadEvent(String modelType, String modelName, String modelEntityContent) {
