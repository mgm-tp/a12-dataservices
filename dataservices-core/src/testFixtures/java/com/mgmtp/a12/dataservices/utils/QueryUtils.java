...
public class QueryUtils {
	...
	/**
	 * Creates a basic QueryRoot with standard projection and paging.
	 *
	 * @param targetModel the target document model name
	 * @return a configured QueryRoot
	 */
	public static QueryRoot createBasicQueryRoot(String targetModel) {
		return QueryRoot.builder()
				.projectionName(DocumentProjectionImplementation.PROJECTION_NAME)
				.targetDocumentModel(targetModel)
