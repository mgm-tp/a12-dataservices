...
public interface PathConstants {
	...
	String BUSINESS_PARTNER_SUPER_DOCUMENT_MODEL_PATH =
			DOCUMENT_MODEL_ROOT_DIR + DocumentModelConstants.BUSINESS_PARTNER_SUPER_MODEL + JSON_EXT;
	String BUSINESS_PARTNER_DOCUMENT_MODEL_PATH =
			DOCUMENT_MODEL_ROOT_DIR + DocumentModelConstants.BUSINESS_PARTNER_DOCUMENT_MODEL + JSON_EXT;
	String BUSINESS_PARTNER_LTD_MODEL_PATH =
			DOCUMENT_MODEL_ROOT_DIR + DocumentModelConstants.BUSINESS_PARTNER_LTD_MODEL + JSON_EXT;
	String CONTRACT_DOCUMENT_MODEL_PATH =
			DOCUMENT_MODEL_ROOT_DIR + DocumentModelConstants.CONTRACT_DOCUMENT_MODEL + JSON_EXT;

	String COINSURED_ADDITIONAL_PARTNER_DOCUMENT_MODEL_PATH =
			DOCUMENT_MODEL_ROOT_DIR + DocumentModelConstants.COINSURED_ADDITIONAL_FIELDS_MODEL + JSON_EXT;
	String ADDRESS_DOCUMENT_MODEL_PATH =
			DOCUMENT_MODEL_ROOT_DIR + DocumentModelConstants.ADDRESS_DOCUMENT_MODEL + JSON_EXT;

	// Insurance document model paths
	String ANONYMIZED_BUSINESS_PARTNER_CDM_MODEL_PATH =
			CDM_MODEL_ROOT_DIR + DocumentModelConstants.ANONYMIZED_BUSINESS_PARTNER_CDM_MODEL + JSON_EXT;
	String CONTRACT_CDM_MODEL_PATH =
			CDM_MODEL_ROOT_DIR + DocumentModelConstants.CONTRACT_CDM_MODEL + JSON_EXT;

	// Insurance relationship model paths
	String PARTNER_POSTAL_ADDRESS_RELATIONSHIP_MODEL_PATH =
			RELATIONSHIP_MODEL_ROOT_DIR + RelationshipModelConstants.PARTNER_POSTAL_ADDRESS_MODEL + JSON_EXT;
	String PARTNER_ADDRESSES_RELATIONSHIP_MODEL_PATH =
			RELATIONSHIP_MODEL_ROOT_DIR + RelationshipModelConstants.PARTNER_ADDRESSES_MODEL + JSON_EXT;
	...
	String CONTRACT_AMENDMENT_RELATIONSHIP_MODEL_PATH =
			RELATIONSHIP_MODEL_ROOT_DIR + RelationshipModelConstants.CONTRACT_AMENDMENT_MODEL + JSON_EXT;

	// Document Models Dir Paths
	String BUSINESS_PARTNER_MULTIPLE_ATTACHMENT_IDS_PATH =
			DOCUMENT_MODEL_PATH + DocumentModelConstants.BUSINESS_PARTNER_MULTIPLE_ATTACHMENT_IDS + JSON_EXT;
	String SUPER_TYPE_MODEL_PATH =
			DOCUMENT_MODEL_PATH + "DateTestModel.json";
