...
public class ExportSeedDataEnabledCondition extends AbstractSeedDataCondition {
	private static final String EXPORT_ENABLED_PROPERTY_NAME = "mgmtp.a12.dataservices.seed-data.export.enabled";

	@Override protected boolean isEnabled(SeedDataProperties seedDataProperties) {
		return seedDataProperties.getSeedData().getExport().isEnabled();
	}
	...
	@Override protected String getDisabledMessage() {
		return "Export Seed Data disabled";
	}

	@Override protected String getEnabledMessage() {
		return "Export Seed Data enabled";
	}
}
