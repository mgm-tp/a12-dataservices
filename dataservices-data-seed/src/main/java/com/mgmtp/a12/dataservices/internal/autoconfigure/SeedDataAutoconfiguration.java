...
import com.mgmtp.a12.dataservices.internal.condition.SeedDataInitializationEnabledCondition;
import com.mgmtp.a12.dataservices.internal.init.SeedDataInitializationService;
import com.mgmtp.a12.dataservices.internal.service.SeedDataService;

import lombok.extern.slf4j.Slf4j;

@Slf4j
@Configuration public class SeedDataAutoconfiguration {

	@ExposePropertiesToActuator
	@ConfigurationProperties(DataServicesCoreProperties.PROPERTIES_PREFIX)
	@Bean SeedDataProperties seedDataProperties() {
		return new SeedDataProperties();
	}

	@Conditional(SeedDataInitializationEnabledCondition.class)
	@Bean @Primary InitializationService seedDataInitializationService(SeedDataService seedDataService,
		...
		return new SeedDataInitializationService(seedDataService, seedDataProperties);
	}
}
