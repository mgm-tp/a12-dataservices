...
/**
 * Descriptor for a relationship link in seed data, including the relationship model,
 * participating entities with roles, and an optional link document reference.
 */
@Data @NoArgsConstructor @AllArgsConstructor
public class SeedLinkDescriptor {

	private String relationshipModel;
	private List<SeedRoleSpec> entities = new ArrayList<>();
