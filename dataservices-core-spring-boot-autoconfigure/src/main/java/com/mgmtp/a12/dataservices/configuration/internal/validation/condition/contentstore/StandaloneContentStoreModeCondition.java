...
public class StandaloneContentStoreModeCondition extends AbstractContentStoreModeCondition {

	@Override protected boolean evaluateCondition(DataServicesCoreProperties dataServicesCoreProperties) {
		return !dataServicesCoreProperties.getAttachments().getExt().getContentstore().getEmbedded().isEnabled();
	}
