...
public class DisabledIndexingCondition extends AbstractDataServicesCondition {
	...
	private ConfigurationMessage enabledMessage() {
		return makeValidMessage("Query re-indexing mode is DISABLED", REINDEXING_CONFIG);
	}

	private ConfigurationMessage disabledMessage() {
		return makeValidMessage("Query re-indexing mode is not DISABLED", REINDEXING_CONFIG);
	}
}
