 ...
 */
package com.mgmtp.a12.dataservices.autoconfigure.kernel.internal;
...
public class KernelConfiguration {
	private final DataServicesCoreProperties coreProperties;
	...
	@Bean public DocumentSerializationConfig documentJsonSerializationConfig( ) {
		return DocumentSerializationConfig.builder()
			.format(DocumentSerializationConfig.Format.JSON)
			.skipTransientFields(!coreProperties.getDocuments().getPersistTransientFields().isEnabled())
			.build();
	}
}
