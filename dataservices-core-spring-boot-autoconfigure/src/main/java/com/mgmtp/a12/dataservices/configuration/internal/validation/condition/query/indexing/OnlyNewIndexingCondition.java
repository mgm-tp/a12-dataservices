 ...
 */
package com.mgmtp.a12.dataservices.configuration.internal.validation.condition.query.indexing;
...
public class OnlyNewIndexingCondition extends AbstractDataServicesCondition {

	private static final String REINDEXING_CONFIG = "mgmtp.a12.dataservices.query.reindexing.mode";
	...
	@Override protected boolean evaluateCondition(DataServicesCoreProperties dataServicesCoreProperties) {
		return dataServicesCoreProperties.getQuery().getReindexing().getMode().equals(
			DataServicesCoreProperties.Query.Reindexing.Mode.INDEX_NEW_ONLY);
	}
	...
	private ConfigurationMessage enabledMessage() {
		return makeValidMessage("Query re-indexing mode is INDEX_NEW_ONLY", REINDEXING_CONFIG);
	}

	private ConfigurationMessage disabledMessage() {
		return makeValidMessage("Query re-indexing mode is not INDEX_NEW_ONLY", REINDEXING_CONFIG);
	}
}
