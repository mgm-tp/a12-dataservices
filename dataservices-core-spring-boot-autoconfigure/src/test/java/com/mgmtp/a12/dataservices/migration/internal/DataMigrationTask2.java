...
@Slf4j
@Order(1)
@MigrationStep(version = "23.3.0", name = "tests", description = "description 2")
@Component
public class DataMigrationTask2 {

	@MigrationTask public void migrateData2() {
		log.info("migration 2");
	}

	public void migrateData3() {
