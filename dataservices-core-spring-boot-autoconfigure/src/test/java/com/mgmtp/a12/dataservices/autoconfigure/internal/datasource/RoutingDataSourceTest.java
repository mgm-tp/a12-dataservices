...
public class RoutingDataSourceTest {
	...
	private TestableRoutingDataSource routingDataSource;

	@BeforeMethod
	public void setUp() {
		routingDataSource = new TestableRoutingDataSource();
	}
	...
	@Test
	public void shouldReturnPrimaryKeyWhenContextIsNull() {
		assertThat(routingDataSource.determineCurrentLookupKey()).isEqualTo(DataSourceType.PRIMARY);
	}

	@Test
	public void shouldReturnPrimaryKeyWhenContextIsPrimary() {
	...
	@Test
	public void shouldReturnReplicaKeyWhenContextIsReplica() {
		DataSourceContextHolder.setDataSourceType(DataSourceType.REPLICA);

		assertThat(routingDataSource.determineCurrentLookupKey()).isEqualTo(DataSourceType.REPLICA);
	}
