...
@ConditionalOnProperty(prefix = "mgmtp.a12.dataservices.enumeration", name = "pageLimit", havingValue = "2")
@Component public class ContractExternalEnumeration implements ExternalEnumerationLoader {

	@Override
	public Boolean isModelSupported(@NonNull String modelName) {
		return DocumentModelConstants.CONTRACT_DOCUMENT_MODEL.equals(modelName);
	}

	@Override
	public ExternalEnumeration convertToEnumeration(DocumentReference documentReference) {
