...
public class LoadAttachmentHeaderOperationIT extends AbstractSpringContextIT {
	...
	@Test public void testFindAttachment() throws IOException {
		...
		assertTrue(PUBLIC_URL_PATTERN.test(header.getBigThumbnailUrl()));
		assertTrue(PUBLIC_URL_PATTERN.test(header.getSmallThumbnailUrl()));
	}
