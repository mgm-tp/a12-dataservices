...
public class MigrationRunnerITWithFullDB extends AbstractMigrationIT {
	...
	void setUp() {
		...
		migrationStepRepository.save(prepareEntity("migrateData"));
	}

	@Test
	public void checkStepClassWithFullRepository() {
