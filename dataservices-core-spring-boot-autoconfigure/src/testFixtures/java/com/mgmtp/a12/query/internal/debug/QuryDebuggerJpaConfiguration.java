...
public class QuryDebuggerJpaConfiguration {
	...
	@Bean LocalizedFieldsJpaRepository localizedFieldsJpaRepository() {
		return new LocalizedFieldsJpaRepository() {

			@Override public void deleteByModelName(String modelName) {
			...
			@Override public <S extends LocalizedFieldEntity> S saveAndFlush(S entity) {
				return null;
			}

			@Override public <S extends LocalizedFieldEntity> List<S> saveAllAndFlush(Iterable<S> entities) {
				return List.of();
			}

			@Override public void deleteAllInBatch(Iterable<LocalizedFieldEntity> entities) {
			...
			@Override public LocalizedFieldEntity getOne(Long aLong) {
				return null;
			}

			@Override public LocalizedFieldEntity getById(Long aLong) {
				return null;
			}

			@Override public LocalizedFieldEntity getReferenceById(Long aLong) {
				return null;
			}

			@Override public <S extends LocalizedFieldEntity> List<S> findAll(Example<S> example) {
				return List.of();
			}

			@Override public <S extends LocalizedFieldEntity> List<S> findAll(Example<S> example, Sort sort) {
				return List.of();
			}

			@Override public <S extends LocalizedFieldEntity> List<S> saveAll(Iterable<S> entities) {
				return List.of();
			}

			@Override public List<LocalizedFieldEntity> findAll() {
				return List.of();
			}

			@Override public List<LocalizedFieldEntity> findAllById(Iterable<Long> longs) {
				return List.of();
			}

			@Override public <S extends LocalizedFieldEntity> S save(S entity) {
				return null;
			}

			@Override public Optional<LocalizedFieldEntity> findById(Long aLong) {
				return Optional.empty();
			}
			...
			@Override public void delete(LocalizedFieldEntity entity) {
			...
			@Override public void deleteAll(Iterable<? extends LocalizedFieldEntity> entities) {
			...
			@Override public List<LocalizedFieldEntity> findAll(Sort sort) {
				return List.of();
			}

			@Override public Page<LocalizedFieldEntity> findAll(Pageable pageable) {
				return null;
			}

			@Override public <S extends LocalizedFieldEntity> Optional<S> findOne(Example<S> example) {
				return Optional.empty();
			}

			@Override public <S extends LocalizedFieldEntity> Page<S> findAll(Example<S> example, Pageable pageable) {
				return null;
			}

			@Override public <S extends LocalizedFieldEntity> long count(Example<S> example) {
				return 0;
			}

			@Override public <S extends LocalizedFieldEntity> boolean exists(Example<S> example) {
				return false;
			}

			@Override public <S extends LocalizedFieldEntity, R> R findBy(Example<S> example, Function<FluentQuery.FetchableFluentQuery<S>, R> queryFunction) {
				return null;
			}
		};
	}
