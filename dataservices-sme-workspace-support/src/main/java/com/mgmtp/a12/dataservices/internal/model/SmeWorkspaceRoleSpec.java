...
public class SmeWorkspaceRoleSpec extends RelationshipRoleSpec {
	 ...
	 */
	public SmeWorkspaceRoleSpec(String role, DocumentReference documentReference, String roleOrder) {
