...
public class SmeWorkspaceInitializationEnabledCondition extends AbstractSmeWorkspaceCondition {
	private static final String INITIALIZATION_ENABLED_PROPERTY_NAME = DataServicesCoreProperties.PROPERTIES_PREFIX + SME_WORKSPACE_PROPERTY_PATH + ".enabled";

	@Override protected boolean isEnabled(SmeWorkspaceProperties workspaceProperties) {
		return workspaceProperties.getInitialization().isEnabled();
	}
	...
	@Override protected String getDisabledMessage() {
		return "SME Workspace initialization is disabled";
	}

	@Override protected String getEnabledMessage() {
		return "SME Workspace initialization is enabled";
	}
}
