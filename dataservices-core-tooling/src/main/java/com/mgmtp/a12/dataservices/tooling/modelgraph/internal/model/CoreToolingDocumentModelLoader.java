...
@Component public class CoreToolingDocumentModelLoader implements IModelLoader<IDocumentModel> {

	private final ModelService modelService;
	private final IDocumentModelSerializer documentModelSerializer;

	@Override public IDocumentModel loadModel(@NotNull String modelId) {
