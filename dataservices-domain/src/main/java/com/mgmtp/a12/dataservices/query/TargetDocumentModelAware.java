 ...
 * Classes implementing this interface are expected to provide access to the name
 * of the document model they are targeting.
 *
 * This interface facilitates the handling and processing of specific document models
 * in queries or operations by acting as a contract for retrieving the associated
 * document model name.
 */
...
public interface TargetDocumentModelAware {
	 ...
	 *
	 * @return the name of the target document model as a string
	 */
