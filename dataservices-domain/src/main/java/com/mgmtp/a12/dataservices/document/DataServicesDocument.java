 ...
 * document {@link DocumentV2}, metadata proxy {@link DataServicesDocumentMetadata} and search service.
 *
...
@OnlyForUsage public interface DataServicesDocument {
	 ...
	 *
	 * @return The {@link DocumentV2} instance; never null.
	 */
	DocumentV2 getKernelDocument();

	/**
	 * Provides access to the metadata proxy for this document.
	 *
	 * @return The {@link DataServicesDocumentMetadata} proxy; never null.
	 */
	DataServicesDocumentMetadata getMetadata();
}
