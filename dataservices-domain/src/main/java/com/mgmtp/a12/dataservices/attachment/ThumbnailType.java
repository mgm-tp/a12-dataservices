...
/**
 * Thumbnail Type enum. Currently, there are just 2 types of thumbnails supported: SMALL and BIG.
 *
 */
public enum ThumbnailType {

	/**
	 * Small preview thumbnail suffix.
	 */
	SMALL("_thumbnail_small"),
	/**
	 * Big preview thumbnail suffix.
	 */
	BIG("_thumbnail_big");
