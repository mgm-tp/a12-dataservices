...
/**
 * Marks a class to be a query operator.
 * To be a valid operator, class must implement {@link ILogicOperator} too.
 */
...
public @interface QueryOperator {
	...
	/**
	 * @return the name of the operator used in the JSON.
	 */
	String value();
}
