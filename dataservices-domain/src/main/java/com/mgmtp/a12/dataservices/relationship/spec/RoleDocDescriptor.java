...
/**
 * Role Doc Descriptor class. Class used in LINK Apis to describe link using just a source document reference, role and relationship model (no link Id needed)
 *
 * @deprecated Not used anymore, will be removed in the next breaking release.
 */
@Deprecated(since = "38.1.0", forRemoval = true)
@Data @AllArgsConstructor @NoArgsConstructor
public class RoleDocDescriptor {
