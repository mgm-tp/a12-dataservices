...
@OnlyForUsage public interface DataServicesDocumentFactory {
	 ...
	 *
	 * @param document Immutable kernel document to wrap; never null.
	 * @return A new {@link DataServicesDocument} instance containing the given document and metadata proxy.
	 */
	DataServicesDocument newDataServicesDocument(DocumentV2 document);
}
