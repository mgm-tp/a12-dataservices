...
@JsonClassDescription("This is the average aggregation function. It calculates the average of the values in the specified field.")
@Data @NoArgsConstructor @EqualsAndHashCode(callSuper = true) @ToString(callSuper = true) @SuperBuilder(toBuilder = true)
@QueryAggregationFunction("avg") public class Avg extends AbstractNumericAggregationFunction {
