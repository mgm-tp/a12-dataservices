...
/**
 * Indicates that a model could not be serialized or deserialized to/from its Java representation.
 * Use when mapping between wire format and domain objects fails.
 */
public class ModelSerializationException extends BaseException {
	...
	public ModelSerializationException(String message, Throwable cause) {
		super(ExceptionCodes.MODEL_SERIALIZATION_EXCEPTION_CODE, message, cause);
	}
	 ...
	 * @param message human-readable description; may be null.
	 */
	public ModelSerializationException(String key, String message) {
		super(ExceptionCodes.MODEL_SERIALIZATION_EXCEPTION_CODE, key, message);
	}
	...
	public ModelSerializationException(Throwable cause) {
		super(ExceptionCodes.MODEL_SERIALIZATION_EXCEPTION_CODE, cause);
	}
	...
	public ModelSerializationException(String message) {
		super(ExceptionCodes.MODEL_SERIALIZATION_EXCEPTION_CODE, message);
	}

	/**
	 * Creates an exception with explicit code and cause for advanced scenarios.
	 *
