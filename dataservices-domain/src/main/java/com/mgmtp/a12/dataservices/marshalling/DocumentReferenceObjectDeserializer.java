...
public class DocumentReferenceObjectDeserializer extends StdDeserializer<DocumentReference> {

	public DocumentReferenceObjectDeserializer() {
	...
	private DocumentReference parseDocRef(JsonParser p, String value) throws JacksonException {
