...
@OnlyForUsage public interface CaseSensitive {
	 ...
	 *
	 * @return true if the query is evaluated case-sensitively; false otherwise.
	 */
	@JsonPropertyDescription("Indicates whether the query should be case sensitive. Defaults to false.")
