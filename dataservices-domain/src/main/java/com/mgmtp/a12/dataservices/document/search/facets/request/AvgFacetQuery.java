...
/**
 * Facet query that computes the average of the specified field.
 *
...
public class AvgFacetQuery extends AbstractStatsFacetQuery {

	/**
	 * Creates an `avg` facet query.
	 *
	 * @param id Facet identifier; produces a corresponding entry in the response.
	 * @param field Index field whose values are averaged.
	 * @param precision Decimal precision to apply when formatting numeric results. May be null to use default precision.
	 */
	@JsonCreator public AvgFacetQuery(@JsonProperty("id") String id, @JsonProperty("field") String field, @JsonProperty("precision") Integer precision) {
		super(id, FacetType.AVG, field, precision);
	}
}
