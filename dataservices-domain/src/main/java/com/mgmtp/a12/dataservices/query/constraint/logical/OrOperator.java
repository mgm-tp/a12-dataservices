...
/**
 * Logical OR operator that evaluates to true if at least one operand evaluates to true.
 * The operator combines multiple {@link com.mgmtp.a12.dataservices.query.constraint.ILogicOperator} operands.
 */
@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonClassDescription("This operator combines multiple conditions using a logical OR. It evaluates to true if at least one of the conditions is true.")
@Data @NoArgsConstructor @EqualsAndHashCode(callSuper = true) @ToString(callSuper = true) @SuperBuilder
@QueryOperator("or") public class OrOperator extends VariadicOperator {
