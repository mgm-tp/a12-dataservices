...
/**
 * Sort specification for legacy RPC queries.
 * @deprecated The class is based on the Solr API which is no longer supported. Use {@link com.mgmtp.a12.dataservices.query.Order}.
 */
