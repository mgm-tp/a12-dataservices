...
/**
 * This exception and its descendants represent errors when the link document is missing in the link.
 */
public class RelationshipLinkDocumentMissingException extends RelationshipValidationException {

	@Getter private final String linkDocumentModelName;

	/**
	 * Creates an exception indicating that a link document is missing although a link model is present.
	 *
	 * @param linkDocumentModelName the name of the link document model for which the document is missing.
	 */
	...
	private RelationshipLinkDocumentMissingException(Builder builder) {
	...
	/**
	 * Builder for {@link RelationshipLinkDocumentMissingException}.
	 */
	protected static class Builder {
		 ...
		 */
		public Builder(int code, String key, String message, String linkDocumentModelName, String title) {
			this.code = code;
			this.key = key;
		...
		/**
		 * Sets a cause exception to be attached to the built {@link RelationshipLinkDocumentMissingException}.
		 *
		...
		/**
		 * Builds a new {@link RelationshipLinkDocumentMissingException} instance using the configured properties.
		 *
		 * @return a configured RelationshipLinkDocumentMissingException.
		 */
		public RelationshipLinkDocumentMissingException build() {
			return new RelationshipLinkDocumentMissingException(this);
		}
	}
}
