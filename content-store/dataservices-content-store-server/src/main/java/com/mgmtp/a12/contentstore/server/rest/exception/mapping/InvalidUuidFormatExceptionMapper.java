...
/**
 * Maps {@link InvalidUuidFormatException} and its subtypes to an HTTP response.
 *
 * @param <E> Type of exception to handle.
 */
public class InvalidUuidFormatExceptionMapper<E extends InvalidUuidFormatException> extends BaseExceptionMapper<E> {

	/**
	 * {@inheritDoc}
	 *
	 * Maps invalid UUID inputs to {@link HttpStatus#BAD_REQUEST}.
	 */
	 ...
	 * {@inheritDoc}
	 *
	 * Suppresses stack trace logging for client input errors.
	 */
