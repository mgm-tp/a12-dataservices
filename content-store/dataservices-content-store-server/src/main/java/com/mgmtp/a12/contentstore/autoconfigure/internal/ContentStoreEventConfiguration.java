...
/**
 * Spring application context configuration for Content Store events.
 */
@Configuration(proxyBeanMethods = false) public class ContentStoreEventConfiguration {

	@Bean public CommonDataServicesEventListenerFactory contentStoreEventListenerFactory() {
		return new CommonDataServicesEventListenerFactory();
	}

	@Bean public ApplicationEventPublisher contentStoreEventPublisher() {
