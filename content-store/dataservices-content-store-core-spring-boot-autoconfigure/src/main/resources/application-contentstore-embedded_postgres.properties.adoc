...
IMPORTANT: This embedded postgres profile should be used only for development or testing purpose only. Persistent data might be lost after restarting server.
...
spring.datasources.contentstore.embedded-postgres.override-working-directory=file:./postgres-bin
----
