 ...
 * @param <E> the concrete {@link MismatchedInputException} type handled by this mapper.
 */
public class MismatchedInputExceptionMapper<E extends MismatchedInputException> extends GenericThrowableMapper<E> {
	 ...
	 *
	 * @param exception the thrown {@link MismatchedInputException}; never null.
	 */
	 ...
	 * {@inheritDoc}
	 *
	 * Maps input type mismatches to {@link HttpStatus#BAD_REQUEST}.
	 *
	 * @param exception the thrown {@link MismatchedInputException}; never null.
