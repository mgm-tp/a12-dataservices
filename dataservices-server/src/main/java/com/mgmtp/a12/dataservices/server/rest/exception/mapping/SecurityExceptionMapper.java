...
/**
 * Maps {@link SecurityException} and its subtypes to response.
 *
 * @param <E> Type of exception to handle.
 */
public class SecurityExceptionMapper<E extends SecurityException> extends BaseExceptionMapper<E> {

	/**
	 * {@inheritDoc}
	 *
	 * Maps security violations to {@link HttpStatus#FORBIDDEN}.
	 *
	 * @param exception the thrown {@link SecurityException}; never null.
	 ...
	 * {@inheritDoc}
	 *
	 * Suppresses stack trace logging for expected security checks.
	 *
	 * @param exception the thrown {@link SecurityException}; never null.
	 * @return `false` to reduce log noise.
	 */
