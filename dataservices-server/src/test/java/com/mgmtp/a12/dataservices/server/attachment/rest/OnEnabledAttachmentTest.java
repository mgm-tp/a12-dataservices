...
import com.mgmtp.a12.dataservices.server.internal.rest.AttachmentV2ControllerImpl;
...
public class OnEnabledAttachmentTest extends AbstractSpringContextServerTests {
	...
	public void testControllerInitialization() {
		...
		AttachmentV2ControllerImpl attachmentControllerBean = applicationContext.getBean(AttachmentV2ControllerImpl.class);
		Assert.assertNotNull(attachmentControllerBean);
	}

	@Test
	public void testAttachmentConfiguration() {
		assertNotNull(applicationContext);
		AttachmentConfiguration attachmentConfigurationBean = applicationContext.getBean(AttachmentConfiguration.class);
		Assert.assertNotNull(attachmentConfigurationBean);
	}
