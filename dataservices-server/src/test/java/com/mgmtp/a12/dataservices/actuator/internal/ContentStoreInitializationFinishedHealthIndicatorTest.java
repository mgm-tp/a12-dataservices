...
public class ContentStoreInitializationFinishedHealthIndicatorTest extends AbstractSpringContextServerTests {
	private static final String HEALTH_ENDPOINT = "/actuator/health";
	private static final String INITIALIZATION_FINISHED_ENDPOINT = "/actuator/health/initializationFinished";
	...
	@Test public void healthEndpointShouldHaveInitializationFinished() throws Exception {
		...
		assertTrue(actualJson.getJSONObject("components").has("initializationFinished"));
	}
