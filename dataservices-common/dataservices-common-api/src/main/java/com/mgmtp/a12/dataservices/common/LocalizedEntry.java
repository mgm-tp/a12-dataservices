...
/**
 * Holds a localized UI message entry with a key and an English default text.
 * The `defaultMessage` may be null if the UI supplies its own translation.
 */
...
public class LocalizedEntry implements Serializable {
	...
	@Sensitive
	@JsonProperty("default") private String defaultMessage;
}
